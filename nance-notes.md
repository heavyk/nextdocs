...
#### 2023-03-10 21:28 - predictive symbols

in addition to what I wrote above, I find it extremely unproductive to believe in symbols, at all. I find symbols to be extremely fun to look at and analyse, but mostly in hindsight (becoming-epimetheus). using symbols as a system for prediction, is as fragile as literally translating every word in a foreign language to your own when just learning the language: it requires all viewers of the symbol to have the same perception, interpreptation, and meaning for the symbols presented.

the next thing to note when looking at any symbolic manifestation is how the symbols (and the implied interpretation) make you *feel*. if they don't feel good, as in inspiring rage, anger, or depression, then that *immediately* means your interpretation of the symbol is not optimal (in either foresight or hindsight).

just imagine for a moment that there was a websters dictionary for symbols, and somehow evveryone on the planet all had the same meanings for the symbols -- that *still* doesn't include interpretation and perception/application of the symbols. therefore, there's no real way to every really nail down the symbols into a prescribed manifestation, as how one *feels* about the symbols still trumps the correct (webster's symbolic dictionary) meaning for the symbols. for example: let's say that clearly some set of symbols implies that the faction which represents my symbol (snake, eagle, or both) is going to have some really bad thing happen to it; let's say it's death of the symbol. well, is it the literally a physical death, or is it the death of the identity of the symbol (meaning, I can no longer associate myself with the snake or eagle), or does it mean the death (or loss) of something in my life that could be identified as a snake? or, does it mean my *personal* indentification with the symbols (because a snake is bottom-up and eagle top-down, but snake represents also knowledge and stuff). there's such a wide array of interpretations that one could come to, I just don't feel symbolic stuff is a very reliable to look into the future.

### 2023-03-11 03:11 - measure for measure

I wanted to put some thinking on some ideas around the concepts in measure for measure, cause I'm not really happy about some things. earlier when writing about [zeus' failed serpent and eagle symbols](/nance-notes.md#2023-03-10-2054---zeus-failed-sign), and [how much folly it is to use it as foresight](/nance-notes.md#2023-03-10-2128---predictive-symbols), in the second section, it felt like someone was sort of whispering in my ear to talk about the ideas regarding death. there's a reoccuring theme in shakespere (like the lion roaring, and other places), where it seems to imply that orgasm would signify death... which is certainly a possibility, as any sudden surge of good-feeling like that could initiate a kundalini rising experience, which, from my experience watching stars is likely not going to be an enjoyable experience. this, I believe is because the entity responsible for limiting my speed has a hard limit on the vibrational speed of my consciousness. the faster I go, the less amount of "time" that I experience -- as in more of my fps are missing (like dropped frames in a video game). this, I figure is the same mechanism that they use to remove my/our consciousness and put us to sleep when they feel like it's time to lose consciousness: simply, if the consciousness input is too distorted (like you're too tired), or the signal isn't receiving well enough (because your organs are failing), then you lose consciousness. if the body cannot regain capacity to receive the signal again, then you die -- else you're just unconscious/asleep.

what happens is when I start becoming more and more conscious, that is, starting to increase that frequency, then that's when the distortion starts to come in, thereby lowering the frequency, and that's sorta unpleasant. if it gets too much distortion, I imagine it's possible for this body to no longer be able to receive the consciousness signal anymore, meaning death.

I don't have to worry about that problem though because I'm not planning on having the kundalini to rise. there's got to be a way where I can simply gain more control over my body so that it doesn't rise. it doesn't seem to me llke this is an involuntary thing, and I should be able to gain control over it.

now, in addition to what I wrote about the narrative realities being a faulty way to predict the future, shakespere has some notably poor renderings of these symbols, [especially in the case of ferdinand](/hara-nots.md#2023-03-04-2340---ferdinands-labour). let's now jump into the difficulties that I have with measure for measure (amongst others that I'll write sara about soon)...

so let's just do the symbolics replacement here. I'm a combination of claudio, isabella, and lucio. all three of these can be seen in me pretty easily (especially lucio), so I'll skip that one. this message is probably the closest thing that you'll get to me/claudio begging not to die. the crime isn't fornication, but entrance ability to see astral and use my imaginary capacity. everyone's doing it, but I'd be the one that would "die" if I were to have the kundalini to rise. the duke is saturn, and angelo is mr. motor(?). angelo is put in place to keep things in order while the duke is "gone" (but really just in disguise as normal everyday people with extremely everyday jobs and stuff -- it's pretty obvious; I'm not stupid, lol).

first of all isabella needs to chill out and just let claudio die. if having sex with angelo feels that bad to her, it's a rock-solid deal-breaker, and there should be no question in her mind what she should do. the fact that she's having so much pain and anguish over it, tells me that she has no idea how to listen to her emotions. I simply don't engage in anything(asterisk) that causes me negative emotion anymore. the whole thing about her virginity and chastity and all that isn't relevant. the only thing that matters is how awful she feels at the thought of doing it. when something feels that bad, there is no reason *ever* to justify doing something that feels bad to you, *even* if it means costing the life of someone dear to you. anyway...

now, coming back to claudio, in the symbolic replacement of fornication for the astral, I don't want it. I like the physical, and I'm perfectly fine if there were a way to simply disable the kundalini rising effect (surely there's a brain surgery or something that can prevent the CSF from rising), and I don't want saturn's stupid daughter either. I don't care how much super great "art" prospero can make conjuring hot babes and stuff; they're not interesting to me and I don't want anything to do with them. as I mentioned elsewhere, hot girls are usually all involved with *appearance*, and so therefore they fall all into the (not all that glisters is gold) or the (the poor "deserved" reflection), or the lead (dull, and slow on the uptake) caskets. none of these caskets are conscious of their perceptive capacities, and so therefore are not interesting to me.

the girls that are interesting to me (in a platonic, not cartesian way) are the fallstaffs, and the malvolios. what I mean by that is, they're getting a different manifestation than their appearance is showing them to be.

however, like I mentioned earlier today, I simply don't want any of that at all. I serve as a demonstration more than anything, so just deal with it. I'm not asking anyone to be any different or anything like that. I figure I can just be physical and rock-solid at that meanwhile all of everyone else is off in their dreamland worrying about how they appear. don't drag me into your dream world. when you're all taking conscious control of your perception, you'll understand why I don't want the duke's help, or to be married to him -- which, btw, when looking at my life and this play, this is a clear case of someone creating a problem for a person, and then solving that problem so they can get what they want from them by looking like a "saviour" to that person by saving them the created problem, then finally giving them what's already theirs -- a very common manipulation scheme.

sure, I'm sitting out, and it could easily be perceived by outsiders that, like achilles, I'm "missing my opportunity" when everyone is coming crawling to me because they finally need/want me, but you simply don't understand how much I don't want to be a part of your world... nothing is lost, I assure you.

P.S. dunno where to put this rant, so for now I'll bury it into this lengthy document :)
