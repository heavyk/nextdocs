...
this is largely because they have a physical plane they need to maintain. I explained that we're basically living inside of the corona of a 7th ray star, which has been caused to become a higher density layer on the onion. below us (the inner earth) and above us (sky, ionosphere, space) is also of lower density too. seems pretty obvious, but as the star gains more hydrogen (ie becomes more attractive), in order for the physical layer we live on to stay tuned to density/frequency of the physical, it has to maintain the density. well, this becomes quite the task, because if below us gains density, it'll push our layer up, just like if you add a higher density gas (like CO2), it'll cause all of the layers of lower density above it to be displaced vertically.

what this means, is that in order for our physical layer to maintain its density, it has to expand as the pressure rises (like blowing up a ballon). these expansions happen at the "fault lines" and create v volcanos/earthquakes as the entire earth expands. the ones that are trying to keep the earth from expanding are doing so to keep the whole planet from getting bigger.

they have a lot of really valid reasons (*la belief*) for doing this, sacred geometry and other harmonious ratios, etc, but the final effect is that, by trying to maintain the density of the planet, they are, because of consciousness's intimate connection to density/frequency, also attempting to limit our perceptive and rational capbilities. they can't allow anything other than physical stuff to manifest inside of the physical, else it'll start a chain reaction of expansion (like a child growing, giants, etc.)

so whoopdie, f-ing doo, I say, because it's not necessary to have a higher density, even though the star below us is also going to have one. I could see pretty clearly all of the different ways that they're going to keep our planet at its "proper" size. eventually though, the planet (just like at the end of the last ice age) will have to expand again. it'll expand, probably pretty big. I estimate somewhere the size of a tiny galaxy, and the crazy thing will be is, it'll be (on the inside) a zone of having an internal sun and a very large space. to those on the outside, it'll probably look like a pretty big planet.
