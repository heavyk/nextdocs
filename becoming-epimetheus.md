...
what was happening, is last night I finally was able to put words to the difference between the different genders of belief. *la belief* is different from *el belief*, which is different from el unbelief, which is also different from *la unbelief*. let's go over them really quickly.

*el unbelief* -- is the masculine perspective (we all have it) which is all of the things that are considered unlikely/lucky/impossible to happen. these are desires and because they appear unlikely to happen, they give excitement, life, vigour, to the idea.they also manifest as fears. as a common example, someone has that secret desire deep down that some imossible situation *could* happen, usually to be saved from a situation, accomplish something, conquer something, etc. it has many names, such as romance, excitment, etc.

*la belief* -- is the feminine perspective of the same thing (belief): *la belief* are all the things that are probable, likely, and expected to happen. I think this comes from "keeping the nest" or something of that nature, and for each of these, there is a corresponding justification and also a corresponding reason for it. I think of this as physical programming and resides mostly in the brain. it's possible that it has a conceptual counterpart, but I think those would be the concepts those thoughts empower -- until it gains enough sustain to become a concept itself. that means that (and is everything from fashions to authorship to games), create concepts -- and, I propose that purely material things, like machines can also interact with these concepts, just like we do. we've got the technology to be able to begin to access that universe-wide web of concepts[^1].

*el belief* -- is all the stuff we're "right" about. there is a big difference between being right about something, and saying that something is statistically or logically probable, which is the case for *la belief*, there is a reason, a justification -- something that explains the effect or the action; these are all statistically probable. we use pattern matching to recognise similar concepts, *la belief* is accessed by touching on different "action points" in the corresponding sequence of actions. I've seen A, B, C, and D, so I know E is right around the corner, as an example.

the sequence of action points which composes *la belief* is different from the masculine perspective (*el belief*) which is being right about something. the composition is the same thing: A is right, B is right, C and D also, therefore E is also right. becasue "right" could mean anything, this masculine perspective *doesn't need to it to make sense or to be logically sound* to be exist. it is because it is (I think therefore I am). we all have many really illogical things that are founded upon faulty or unlikely logic, and we're right about each of them.

*la unbelief* -- is simmilar but not indifferent to *el belief*, which are all of the situations that one doesn't have explanation. these are the things that bother us and form the opposite side of the fear aspect (because they're unknown/misunderstood).

(reading el belief again, I noticed the circle)

---

those differences are important to see because they illustrate the next great revelation that I saw, which was how we got to this moment where we began to build our reality out of these four elements. when enki and ninhursag were creating humankind as primitive animals, we weren't capable of taking symbolic instructions, and that was because we were missing this "fire".

this fire is our ability to attract, make things happen, create reality, make tools, solutions, inventions, etc. -- however, that's only looking at one side of the concept: on the other side, it was easy to see that in for us to be able to take and execute symbolic commands, we need to have a sense that we're doing *the right thing*, and in doing the right thing, we are right. the command is the right thing to do. we *want* to follow commands, so we can be *right*.

therefore, it has been the objective of the gods since the day one to tell us which/what way is the "right" way. they authorise our reality by becoming the authority on what is "right". because we all want to be "right", we're caught endlessly trying to fill their description of what is "right". right is a different dimension to legend though, but if you're trained to give importance or power to righeousness, it's pretty easy to see why that would want to be perpetuated. these forms of righteousness pass around and move about in social construtcts, spanning multiple dimensions of social, family, ideological, grouped people. this includes most visible religious and governmental institutions. they're called "laws" cause they're meant to be followed, so we can be "right".

in a social context, this is the culture of the organisations that you're a part of (family, church, bars, work, school, etc) and what each one of these value. to be a part of that group, you have to adopt their values (or hide that you have disdain for them).

we also see this group thought show up all the time in sports and other games of competition as well and this is the beginning of its redeeming factor, because we equate winning with being right -- and if the team/side I'm on is winning, then I'm right about their cause, even if it's putting a ball into a net. I'm winning now too and that makes me right. eventually one learns they already are right, they don't need others to validate it as true, it can be enjoyed like a dream.

---

the desire to be right about things (*el belief*) was especially prominant for me in the spanish culture (and it wasn't until I saw theirs I could see american's need to be right, too). the spanish people and culture as a whole represents to me as a self-similar resonance to the macrocosom of our internal mental struggle of wanting to be right. the desire to be right about things shifted a few times for me in spain and is where I developed this theory so when I say them, I'm referring to how I learned it. I recognised an aspect of myself (this principle of how I'm prdogrammed) in myself as a reflection of their culture (spain is the female and I'm forethought and afterthought as one. she takes those and twists them according to her perception of reality (culture) and spits them back at me in the form of egregores).

*el belief* (things we're right about) is in constant competition with *la belief* over what is real. for her, it's only the stuff that's probable, likely, justified, or logical. *el belief* is all of the things that we hold as true and we're right about them because they're *true*. they're often commands that we've been given and this is mainly what the gods most basic form of manipulation. they're up to new tricks now, but for millenia, our concept of what is right has been manipulated to fight wars, and all kinds of other savagry. *la belief* is all of the stuff that has a reason or a justification for existing and that's pretty ancient as well. we've developed this over time and I beleive that there is probably a genetic component to it. I don't know if there is a genetic component to the other three though. rigth people tend to collect into groups over their ideology. they are physical sattelites, orbiting a concept.

the constant conflict between these different perspectives of what is the definition of reality, takes on the dialectic of "forethought" -- which is the ability to predict what will happen in reality, and "afterthought" -- which is the ability to understand, or justify a previously manifested thing. everything we know and can perceive is a vector between these two dialectics in reference to the perceiver/observer.

the dialectic between these two forces is premetheus' fire. we create reality by *being right about it*. the universe aims to ensure that we are right as often as possible about everything we believe.

[1]: obviously we can only access concepts that are similar to us. as an example, I rarely, and less and less now access an entire section of what most people think of as "reality". those things are largely invisible to me. I walk through the danger like a fool, captivated by my own pontifications.

### 2022-11-29 13:03 - summoning epimetheus

yesterday, there were also quite a few different feelings I had based around the idea of summoning me (or anyone else similar to me). I explained that for me, prometheus has indeed left the building. I have very little capacity now for forethought. if you're anyone like me (which is everyone besides the noseboys and tesla), then the archons are going to be continually keeping from you the capacity to look at conditions and upgrade your performance (epimetheus), but most importantly, they want to control the timeline and what is manifesting inside of it.

this is largely because they have a physical plane they need to maintain. I explained that we're basically living inside of the corona of a 7th ray star, which has been caused to become a higher density layer on the onion. below us (the inner earth) and above us (sky, ionosphere, space) is also of lower density too. seems pretty obvious, but as the star gains more hydrogen (ie becomes more attractive), in order for the physical layer we live on, to continue in the visible spectrum (the physical), it has to maintain the density. well, this becomes quite the task, because if below us gains density, it'll push our layer up, just like if you add a higher density gas (like CO2), it'll cause all of the layers of lower density above it to be displaced vertically.

what this means, is that in order for our physical layer to maintain its density, it has to expand as the pressure rises (like blowing up a ballon). these expansions happen at the "fault lines" and create volcanos/earthquakes as the entire earth expands. the ones that are trying to keep the earth from expanding are doing so to keep the whole planet from getting bigger (and, this I believe the role of vulcan/tesla down at the south pole as the failsafe, but that role has been handed over, probably relatively recently, to the US govt; they're mithras now).

they have a lot of really valid reasons (*la belief*) for keeping the physical plane (the one we live on) at a constant speed/density, sacred geometry and other harmonious ratios, etc, but the final effect is that, by trying to maintain the density of the planet, they are, because of consciousness's intimate connection to density/frequency, they are also limiting the physical conditions which lead to essentially superhuman logical and calculatory capabilities (and all of the singularity stuff).

though our perceptive and rational capbilities have been physically limited by maintaing the densitty, and also preventing the planet from expanding, they've given themselves the most difficultc job to do. it's pretty close to impossible, so we'll see how that turns out (oh, nm -- guess they don't. tesla/vulcan's on it). interesting. anyway, so anyway, they want to keep us and all of the stuff we think of as physical to remain in physical -- pretty obvious. a small thing like beginning to manipulate concepts other than your own could pretty easily cause a chain reaction of expansion (like a child growing, giants, etc.)
