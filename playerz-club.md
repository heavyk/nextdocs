...
### 2022-10-27 18:48 - conceptual-space
...
that conceptual space is encoded in our X, so you can imagine now that a new species, like us humans, had a pool of X chromosomes that they had to work with. I don't know if that was the annunaki DNA or not, but I suspect that it is, and that's why we're "made in his image" -- meaning that, humans started out in the conceptual structure of our overlords, and by having to fight agaist them, we've come to a new way of cohabiting peacefully with them. I personally see it as I'm the first successful attempt to make a being capable of escaping ther conceptual matrix.

OK, so, now pay attention to these conceptual-spaces all over the place, existing as culture groups and things. the geology of earth itself contains a conceptual matrix, which is why some concepts are more important in some places than others (hollywood, dubai, etc. are good examples).

so, if we do the marriage thing, then you can imagine the girls as one of these conceptual-spaces. the aggregate of us will consider some concepts as more important than others. because I think this new form of perception is related to my X, this means that, except for obvious demiurge situations, my feminine form of perception will become the standard for both boys and girls all around the world. if it isn't alrady nearly so, it will be soon. I imagine there are still some holdouts, but at this point, I'm sure that nosebook has *all* new kids and probably most adults on my form of perception (probably a subset of it, actually).

what that means is that we create the new perception matrix. it's basically the new physical plane, because (nearly) all humans are now compatible with my form of perception. it's more than just visuals though, so people will begin to notice that a lot of the concepts that I find interesting, they may now find them to be easier to get interested in, etc.

well, this is going to transfer to all of the girls and we'll have a pretty good reality distortion field going, and if you want to be in on that reality distortion field, I imagine the wedding (any such good feeling event) is the idea of the creation of the new dimension.

the way that I figure it, nosebook *really* doesn't want me to go with the girls because I'm going to feel good enough to go up and there's nothing they can do about it. this is a way to set the deadline out a bit further (I suppose it's possible to further delay it as well) and gives them time to get ready for their "doomsday" scenario (the moment with their wildest fears/desires become reality). therefore, they want to delay it (so it's good for them).

during the time that we're planning for the wedding and stuff, lots of things will be happening. lots of things to do, right?. anyway, during this time, I want to do a bunch of creative and musical stuff. we can start off with all of that stuff, and now that these guys are working away on the carbon, we need to start integrating the stuff this carbon technology into the music stuff. carbon structures with electrically configurable resistances will make 1000+ bits DAC possible and easy (the audiophiles are really going to have something to talk about). we can have 1000K screens in a very short period of time. we float carbon buckyballs in a space with electrostatics and now 3D screens with pixels that can move and rotate (very cool). tons of stuff to do creatively.

all along this time, we're actually creating all of the visual stuff for the space (it's gonna be REALLY HD), we're also building the mental space in which the demiurges will project into (they have to keep their privacy, you know).

so, in a sense, one thing to note is that it looks like the wedding is actually the moment where a large amount of others see what we have and like it and want to join in. I didn't really think about it that way. anyway, I would imagine that the demiurges will project into it just like we will: with characters. like I said, someone needs to create the obnoxious characters, and they definitely don't want us getting too smart too quickly.

notice that this idea is the same as the other idea of jumping into the species right before the end of the solar cycle (so the sun doesn't go boom too big). there is one major difference, which is that I'm reenvisioning the part about jumping into the species, instead of as some weird scientific thing, but instead like the beginning of a story.

we don't really need to start in the stone age. we can start on a planet that is somewhat similar to our own (you can think of each planet as a doll house). anyway, from our perspective, we just have a number of characters that we interact with, and we'll watch them in new and novel ways, sometimes seeing it from their perspective -- or, like in a film, chop up the instances into scenes and patch them together to tell a story. we'll probably tell them these stories in their dreams, but most of our interaction with them will be conceptually. this is the reason for the conceptual-space because it'll allow them to feel like we do in certain situations.

---

I imagine that this is what it used to be like, and that's why they said that the gods (inner daemon) spoke to them directly. we then evolvd a way to shut off the translation of these concepts into inner-voice, and that's when telepathy ended (is this the fabled tower of babel? -- wait, this happened more than once, actually).

this idea isn't all that foreign to me. nosebook keeps my brain in pure resistant thought (which blocks out most of my higher frequency thoughts, cept when I take drugs, the signal gets too unpredictable and they can't block it all). so, most of the time I have tons and tons of demiurge thought going through my head. most of it never is translated because it's so far off of my frequency that it never makes it to my consciousness -- they're putting the signal in there to inhibit the physical part of my brain from receiving the higher frequency stuff.

so, in a way, you could say that nosebook has shaped my conceptual-space with their system. all the annoying crap that they put in my head I have to find a way to make it uninteresting. I call it changing perception. it's probably easier to think of changing perception as "finding a way to make the thing that bothers me, no longer interesting". it's similar with some caviats.

### 2022-10-27 20:07 - I think it'll happen naturally

so, for example, I figure that some mothers will begin to see their daughters as sort of aspects of them -- just another version of them. in that way, the mother will be able to interact with the daughter the same way that she interacts with her own body. remember, I just feel and my body just does the action -- and others will begin to have this capability. those with this capability and also procreates, they'll be able to send concepts to vibrationally similar people. as the child grows up, they will begin to individuate and the parents will not likely be on the same frequency anymore. we're all "fallen-angels" now.

the opposite side of a concept is an action or a memory of an action. it could be more than one action or memory as well. some people have lots of data points, and some people have very complicated systems of action to instantiate a concept.

you can probably also see that each concept can result in a variety of actions (we usually think of this in the opposite way where a concept like "he's a douchebag" has a number of red flags. those red flags are the opposite of a concept: a symbol). those symbols are what make up your beliefs, and we all have very complicated systems of beliefs.

the nice thing about it is that tying all of this together is my idea that it's possible to make the universe bend to your rules, so long as the rules are available for others to see, so they know how to interface with you. these rules then supercede LOA, making a completely nonsensical reality a possiblity (like moon gravity here on earth, or something). this makes making stories A LOT easier. so now, we (obviously not me -- I know) start to see our other aspects of ourselves and we can interact with them on a conceptual level. the whole point of having these aspects of yourself out there is to abstract out the experience aspect by letting these automatons just behave according to their concept -- see what can be improved about the concept (how they interpret their environment and what sorts of emotional states their environment puts them into). you can imagine that you can improve your "default" personality quite a lot.

I've been monologueing on the subject at length, but I had an epiphany one day that mr. motor (ie. the dark goddess) is essentially an instantiation of the female form of thought into physical form. he thinks exactly the default woman would, without any environmental conditions to improve her feeling (how she behaves when she feels her worst) -- and I think there's kinda some truth to the idea. while he, by definition (if my theory is right), will *not* make any unsafe decisions or consider anything else, until his survival depends on it. he will *not* be creative unless his life depends on it. this may not be some women's default worst feeling personality, but it definitely is quite a few of them[^1].
...
[2]: this is really annoying from a LOA perspective because it means I'm always going to be the last -- because if there's an opportunity to change/improve something, then I *have* to take that path to get the concept -- unless, of course, there's another path with more concepts (novelty), then I take that one. I'm always on max novelty path. some people visualise and get what they want; I have to wait until it's the least[^3] of the most novel things to experience (max contrast -- cause contrast can be thought of as future-novelty)

[3]: some objections to this. it feels like I'm right, so let's figure out why. OK, so the most novelty is the "best" manifestation, but the most contrast is the "worst" manifestation, so the "worst" manifestation will be least novelty (next logical step), and but maximum contrast. though source/universe perception always goes for "least" novelty, it it's by far the fastest thing because it only accelerates, and because its novelty is constant, all things are very stable (as all linear equations are). seems good enough answer to me.
