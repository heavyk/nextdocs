...
as was explained elsewhere, the control of the summoning of a saviour or any other type of egregore was dramatically increased in the end days of atlantis, and then further rejected by the aryans rejecting the astral control system. being unable to control the planets, they felt helpless to control their destiny, so tbey created super summoning humans, which are essentially like the borg in manifesting their own thoughts into reality. this again was controlled (tower of babel?), and was set into another astrlogy-based system wherby our destiny is controlled by the planets (probably ra/zeus system). saturn reworked the 3rd ray system, integrating concepts (5th ray) into the 3rd ray, allowing these concepts to manifest into the astral.

we summoned all of these concepts/egregores into reality by our own focused thought and desire. just like the illiad and helen were to the ancient greeks, enlil was the old/awful 2nd ray perspective prior to the present one. we were locked into the destiny determined by our own egregores (like the devas), now this new 2nd ray perspective allows us to summon our own. simply put, our desire is reaching high enough amplitude and frequency now for us to redily summon these concepts into physical conditions on the planet (like heat, and weather control), and so now the steady/constant "divine order" of these manifestations of these narrative elements is no longer determined by the planets through the "bond heaven-earth" made through the great pyramid and other megalithic structures.
