...
my emperience with sound, has taught me that adding more low vibration (bass) instruments, just makes that frequency range sound muddy. no matter how muddy the low vibration is, the high vibration sound will still carry over the top and doesn't get interfere with the lower vibrations[something like that. prolly not the best description. maybe there's a better way to illustrate this concept].
