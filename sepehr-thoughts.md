...
it looks like we see 7 but 3 (triangle) are invisible, the 5 sees all 4 (square) invisibly, and only 1 ("the one", singular perspective) visibly. there's one more I explained above, but I can't see it -- the one of 4-2-1 four visible evens, 2 invisible evens/odds, and l visible even/odd.
