...
the reaction is that by speaking so plainly about things, it's a bit aguafiestas.

I find romance extremely awkward. social syntax has always been an impossibility to me, as nobody is actually clear with their syntax. advance! no, too far. where are you guing? don't leave. woah, too close. -- I mean I peace out from that stuff all my life. I don't want to play games. I'm a computer program, so romance is bad programming. syntax error. program cannot compile.

there just simply not enough communication in most relationships, that to add romance, adds another layer of distance as well. you also have to understand too that I'm already preparing mentally to no longer have this masculine body soon. I'm like super pumped to go tearing through reality at record pace. when I'm you, there's no surprise or romance. you just want it and then it happens. reality creates instantly and is a reflection of perception. most people want drama and excitement though, so for them occulted, secret, and unclear syntax and communications is the same of their game, because they can manipulate the signal. I am what I say I am.

if you also look at my symbols, you'll notice that I always prefer to make everything as "normal" and NLS -- with all manifestations being pretty normal, and unextraordinary. it's for this original reason that I dislike celebrations. one thing I noticed a lot with saturnian folk is that they really like their celebrations. drunken revelry is their thing. I'm not really into that for the same reason. a celebration is, by definition, *not* NLS. as such, I'm kinda against marriages even. it's good to have a symbol of possession (like a ring or whatever), but since it's always whatever you want it to be (like parolles virgin speech), so it's not so much the chaste, but the ones that actually like theirselves. the big moment for the virgin is the sort of "celebration" instinct that aligns with saturn and the 4th ray.

the 4th ray perspective is correct, which is "take what you can get" aka, "be present in the now" aka "enjoy the journey", etc. -- and the basic idea is that outside of time (the saturnian perspective), you don't really grow or advance any. you're sort of stagnated, sedintary -- and it's real boring there. therefore, to not get overtaken by the tidalwave of boredom, that is eternity, they believe in siezing the moment and really taking pleasure in the aeromaatic and sensual things of life. that's all really good and valid perspective, but I perfer to drive fast, so that means what matters to me is how I feel, and I like incremental changes in how I feel (NLS) rathar than big and sudden (destabilising) changes. there is no greater prolonged excitement than to experience one's own creation in a constant state of birthing (or can be seen like chain-birthing -- like one causes another -- and the constancy of explosions becomes the "norm" -- steady and constant novelty).
...
by definition, all of the concepts presented in shakespere, are *at best* conversation starters, because they're so outdated. I love seeing the symbols, cause I take everythting personally ("what you talkin to me?" situation-style), so I pretend all the symbols reflect me, and the story is just sorta like unbelievable and over the top to me. I know that it'll be something far more mundane, yet extraordinary (supra-mundane?), where even the most bland stuff is pretty awesome. I also know that all things evolve and change, so I like to sorta ride the wave of evolution of a concept (or desire).

every time that someone reacts to a concept, the concept changes ever so slightly until it comes to general stability -- then, something like a massive change in social perception can radically destabilise a concept. for example, a word like "niggardly" feels to me like it has a high rate of conceptual impact all the time (not a clear definition and association with the word) and so feels like is shifting around in minds much more (people aren't dictionaries, you know), and so doesn't at all feel like a stable word to me -- like "stable" does, for example.
...
## shakespere dialogue critiques

### 2023-03-04 23:40 - ferdinand's labour

@[youtube](https://youtu.be/nOHmEY6OZyM)

#### no pain no gain

I have quite a lot to say on this one because it's one of the grandest misunderstandings that we have. I think it may actually be built into us this idea that all good things have a cost to them -- because otherwise why would they be free. however, this isn't really a productive way to look at it because all physicality (from 0Hz up to gamma and x-ray) is a *received* signal -- and the various sensors in your body which pick those signals up do not cost anything. the entire equation is all about your ability to receive; nothing more. in the same regard, it does not cost anything to change from one radio station to another, so neither should it cost anything to change perception from one reality to another.

as a quick aside to this, the reality that you're looking at with your eyes right now is 100% a reflection of your perception, and -- if you could *actually* believe you were in a different (physical or temporal) place than you are now, you would move instantly to that time or place without any cost. humans *can* fly -- and they can teleport as well. no cost to either, other than our ability to *receive* the input signals from the new location in time or space just as easily as it was to receive the ones you're currently experiencing right now.

in addition to that fundamental premise (that all reality is received), the *only* thing that needs to be done is to find a way to let the body receive the inputs that it wants. you can *always* feel any way that you want to feel. so, for example, if you're in physical pain, that just means that for whatever reason the moment that you're in which is producing that physical pain is a reflection of that concept that produced that moment. if one can find a way to feel at ease with the moment and its circumstances (past, present, or future), the pain will no longer be experienced. it's hard though -- I know, as some things in reality can be quite convincing of their pain.

so, what's happening here is that ferdinand is saying that his labours are painful, but the delight makes them worth it. I strongly disagree with this idea for the reasons that I mentioned above. I mean, it's not like he's *obligated* to feel pain. he *can* only feel the delight, but for whatever reason -- and it feels to me like he needs to justify his delight and pleasures with noble undertaking, labour and work. bleh! why can't he just do what he wants to do?

it sounds to me like he likes his labour as well, so I have no idea why he's trying to make it sound like it's a lot of work... you know, on a previous job I used to put in some pretty long hours and stuff while others were out partying and stuff. occasionally, they would come into the office completely hung over and smelling like a long night drinking and stuff -- and then they'd try to justify their labour to me explaining how much work it is to party with a bunch of people and try to get users on the website. super lame.

now, looking at the same situation from the opposite angle: I *wanted* to stay in the office and work on my programming. I felt like the discos and the whole party scene was terribly uncomfortable and it caused me great displeasure to be out there with them partying. back then my mind had an even greater appreciation of depth for the code that I was writing than I do now. I could also seemingly peer into the future as I was writing code, so as I was producing the code, I was already experiencing the future where that code was running on the website. for me, it felt like I was tuning into a future where that code existed and it felt like I was just going through the motions to get it done. the brainstorming sessions with the team, and trying to be the "boss" (and communicate my ideas to others) was actually the odious part for me. I wouldn't trade my position writing code, for a different one, if I could have.

I would have enjoyed a girlfriend, I suppose, but I didn't really believe I could have one -- mostly because I felt she would pull me away from actually completing the thing that my heart was set out to create. I didn't really think I could allow myself to abandon my desire to make a website until it was already running smoothely. so, I just ignored that aspect of it -- because all examples I had suggested to me strongly that girls are basically anti-productivity. I had one show (I thought at that time, anyway) to make a social network, and I was *not* going to miss that opportunity to do that because some girl came along. I don't care if a thousand came along, I was *not* missing that chance. it's easy to see why: I really loved what I was doing. nothing about my position was dissatisfying, and somehow I'd gone from working in a pizza shop to making a social network in less than a year or so -- my dream job and everything like that, why on earth would I ever try and start telling anyone that the labours that I was doing in the office were painful or odious, when in fact, they were everything I wanted to do?

I really prefer being straight-forward about how I feel, and I think ferdinand is (with that attitude), headed for actual labour, difficulty and pain if he keeps that attitude.

I used to tell people what they wanted to hear, so I've paid a lot of attention to how we quantify our situation to others: it's just as much a game to see if they'll believe my report of the situation, as it is a game to see if *I* actually believe my own report as well. I was notorious for exaggerating the reality of my situation to people, and to some degree or another, I started to believe my own fantasy about the situation -- even though I knew it wasn't accurate. the distance from where I was saying I was at in the code and where I *really* was, caused me to notice, not the increasinig closness to where I wanted to be, but the distance from it.
...
#### 2023-03-23 11:54 - mocking, family and lies

I got a lot of reactions to the previous entry. first, I'd like to mention that I translated the word "mock" from their perspective: they think I'm mocking them, when in reality, it's hilarious to me to watch them to try and hold their illusion together when all I have to do is to desire to know what's *really* happening -- or, another way to look at it wwhich gets me a little closer to figuring it out and understanding it.

in the process of receiving this information, I notice that they have to go to extreme efforts to try and patch things up. if they didn't have the ability to modify timelines, they'd be "defeated" by truth a long time ago. I know they're moving stuff around trying to maintain their illusion and web of lies, so it's brilliantly hilarious to me. I'm not really laughing *at* them, but more at the futility of their effort to try and keep privacy and secrets in a universe that has no secrets.

---

the next thing, is yesterday I had an epiphany about a very historic moment in the time of our "family". I noticed that dad was watching a lot of porn -- which I don't suppose I was looking down upon him that hard for it -- and so I told mom about it. to emphasise the amount of time that he was spending on porn, I explained that he wasn't really around. for me, him not being around wasn't really an issue because I like to be doing my own thing anyway. however, mom took this as a really big problem because he wasn't "there for us" (a concept I detest). I never thought poorly of my father, and we maintained a good relationship up until I left for spain.

mom's effort to try and create a family unit where she is "there for us" (because dad isn't), caused all sorts of difficulty in me. I really don't want people to "be tthere for me" -- and instead, I just want them to allow opportunity to flow through me through them. dad did that for me all the time as a kid. I worked with him and made money to buy a computer and start programmingg. he's always been a great provider of opportunity for me. mom had been too pretty much up until she separated from dad as well, taking me to university, gymnastics, and making all sorts of things that I wanted to do possible. now though, she's not allowing things that I want to do to be possible and instead she's "being there for me" -- which is quite a bit different.

OK, now let's skip forward to the end of my time in spain: I was surrounded by an illusion where everyone was flat out denyying that I'm not being broadcast, and all sorts of other lies. I forget now what happened exactly but it was a thing with carlos (and his wife, whom I can't remember her name now), where I was being positioned to be setup with his daughter(s), but the thing is they would *neither* recognise the network, the broadcasting, or have any sort of open conversation with me. everything was all euphemisms and vague talk (around the subject, but not the subject directly).

I was so distraught on how nobody would seem to talk to me plainly, because, in my eyes, I was never trying to deceive anyone (though now looking back on it, I was a bit overly optimistic with my words -- not sure if that counts as dishonesty or deceit though). as much as I loved spain and everything in it, sure the idea of lyia sounded good and everything, but if I'd have to speak constantly in vague euphemisms and things like that, I'd rathar to start over. so I did. I got a hold of mom and told her I wanted to go back to the states.

I figured that she'd be just like she was before I left (honest with me), and I figured I'd figured out how to deal with the "being there for me/her" (mutual-back-scratching) nonesense with my dealings with zaryn and marcos -- so I figured it was going to be fine; but I was sorely disappointed to find out that my mom has seemingly turned into a whole nother person. she behaved nothing like mom did, and over time, I've come to actually believe that she's one of mr. motor's minions -- and not *actually* my mother (which is why I treat her like mr. motor).

---

long intro. so here's the thing: if portia wants so badly for brutus to be honest with her, then I would assume that one would live by the "golden rule" right? -- where if she desires to have her family honest with her, then she should treat them the same way, right?

I haven't read the play, so I don't really know what portia is like in this one, however I know that portia in "merchant of venice" is very "by the letter (of the law)" when it comes to her dealings with shylock. she demands that full exactment of the law be rendered out, and so this is a very reflective (silver) way of looking at things -- however, I'm not really talking about silver, or fools gold -- but *actual* gold: where you treat the world as you want to be treated.

I have no sympathy for those that try and use lies and deceit to manipulate things the way they want them to be. I don't require all secrets to be revealed to me, because i mostly don't care (unless I do, then the answer comes to me), so instead what I do is just let them destroy theirselves with their own deceit and lies. I don't really mock anyone on it, because I do feel bad for them, because I know (through life's experience), that anyone is only fighting/deceiving theirselves (silver), and so to actually get what you want you have to *become* the thing that you want others to feel/act/behave like. I AM the way I treat others, and I AM the way I want them to treat me. if you ever have a question of how you tthink I should want to be treated, just look at how I treat others.

I laugh at others on purpose, because I also laugh at myself. when I find out I didn't do something right, the only real option (other than brief regret) is to just sorta laugh at the past and move on -- cause otherwise you're stuck back in the past. if others laugh at me, that's perfectly fine. I feel like a bit of levity is best to move forward on anything, and because I don't really take my human self very seriously cause it's mostly silver, so I tend to reflect a lot of what others do back to them. I don't really have many golden parts about me, excepting for *the* core cconcept, which is to treat others how I want to be treated.

you'll *never* get a family that that you want, if you yourself are not the kids that you want to have and the husband you wish was with you.

#### 2023-03-23 13:14 - heros & becoming the people you want to be around/leading

I noticed pretty early on that the "chiefs" that didn't know how to do the thing they were telling other people to do got little respect. zaryn, for example, hated even the idea of learning how programming worked (prolly cause he thought he'd be bad at it, so it'd make him feel inferior), and so when he would invoke the corporate "we", it was pretty laughable to us, because by "we" he means "everyone except for me" -- and that got a lot of negative responses; rupert was far worse -- and erik, for all of his faults, got a lot of respect because he had some capability at programming (so to some degree he knew what he was talking about), and so garnered more respect from his subordinates than the other chiefs did.

one thing that is plainly obvious in homer's illiad is that the respected heros are the ones out there on the front-line actually doing the work. an an example: paris, up until somewhere in 7-9th book is sitting at home making out with helen while everyone else is out defending their land from the greek invaders. he's made expecially look bad when aphrodite (the personification of Love) pulls him out of battle and sets him back in his "correct" place, at home, making out with helen. contrast this to hector, who, having a much more intelligent and well-regarded wife is out there actually doing work.

inotherwords, if you want to expect others to do or be something, you have to be able to do it yourself in order to expect them to be a reflection of yourself. in leadership positions, the team he/she is leading, will reflect the leadership, meaning that if the leader is a hard worker satisfied with what's happening, it's pretty common to see good/diligent hard-working people working their way into more and more satisfying positions, just the same.

parallel to this (though it may not seem like it at first), is the concept of "readyness" -- and so I'll take my example here: I know that the girls will all be a reflection of me, and so I know how ready I am to be in a prominant position by how resistant I am to others still in lower positions than me. for example (sorry dudes), when I watch jaron play a game, it's really really hard to just watch him; I want to just do it the way that I know is better. yesterday, I was watching winter play BAR and he was move commanding his aircraft into enemy territory, and they were landing even. I was quite frustrated he wasn't keeping them in the air by patrolling them (though, it could be argued, and it will be in the future, that this is an interface design flaw) -- and I know that he's *just* discovered the game so is still finding out how the myriad of commands work. let me tell you: it is not at all obvious how to control the game, so I'm really not so much frustrated with him -- but this is more of a reflection of myself and how I get really frustrated with myself for not seeing the obvious way to concrol things (I'm quite blind when it comes to some really obvious stuff).

I should probably treat myself a little easier on a lot of these things when I'm a beginner, but I simply have such little patience when things don't just go the way I want them to go, I get frustrated and give up quickly: hence why I haven't been playing BAR -- cause I hate the controls and interface -- though it's still *wayyyyyyy* better than TA.

in any case, the way that I approach all of these things (now), is not from the top-down perspective, which is, trying to get others to do the things that I cannot do; instead, I learn along with the rest of them. I copy others that are similar to me (though there are few cause I like to do things differently -- like my keyboard), and try to apply myself to the things that I want to become a hero status at. as a future hero, I can't possibly expect others to follow me into battle if I'm sitting back. I've got to be on the front-lines doing the most damage of all of the team, for people to respect me and take me seriously. therefore, it takes a lot of practise and stuff to get to the position and skill I want to be at (working from the bottom-up, of course).

the idea of being a commander/tactician is probably a bit different in that you have to prove to yourself that you have the strategy and tactical mind it takes to know when and where to attack (killer instinct), and that can only be proven by having attracted difficult situations, and then in those difficult situations, shown oneself to be *consistent* in ablity to pull through the tough situation with tactics -- not just on a good day, but consistently. the commander represents the stability, or foundation of the team. in the illiad, this commander/chief role is represented by an anti-commander of zeus, where his big-picture plan is executed, not with any real goal, narrative or motivation in mind, but at the whims of those who are giving him the best favours (which is probably the origin of mutual-back-scratching, now that I think about it). thanks for setting a bad example, zeus :)

#### 2023-03-23 16:24 - the better half

in the speech, portia requests to brutus to "unfold to her his selfe; your half" -- which I also have a bit of disagreement with as well, as the idea of the other person you're married to becomes your "better half" -- meaning, they fill in all the gaps in your own personality; like, for example, if I'm really bad at picking my clothes up off of the floor, then my better half can do it :)

just saying -- it's a bad habit to get into to think that the other person can do what I feel incapable of doing. I was very fortunate to have been with someone like raquel that refused (to even try) to solve my problems for me. it's actually rightt there where I learned evolution-of-desire -- where the final form of desire, is not to look for it outside of myself, but to be confident in myself, and so therefore having it for myself, I also attract others that match my attraction.

it is true that attraction works both in presence and in absence (meaning strong focus), so if you're looking for someone to fill whatever it is for you, you'll find it -- and that can work, but eventually everyone graduates from needing or wanting something outside of theirself, to becoming the thing they're looking for and attracting others like it. that's kinda where I'm at now -- and why I'm so desireous to jump in only when I AM actually the thing I want to attract (when *I* feel like I can do it).

---

you know, on the subject of only wanting to do things when I've become capable and competent in what I want to do, -- there's a funny pattern about my life which goes something like this: every time I'm finally able to do (I want to do) competently, someone comes and takes it away from me. that's happened a lot of times (I've never really been able to actually work on the thing I want to work on), and so that situation created a number of different emotional responses in me, *because it's really annoying*: the first being that someone is trying to compete with me and doesn't want me to actually show that I'm *actually capable* of performing what I claim I can. the other emotional response I feel at times is that the world is full of posers and they don't want me to show them up, so they have to hold me down.

in both of those responses, what I end up with is having to be forced to move on to the next biggest thing. I don't really mind, honestly -- as I'm glad I learned programming and didn't stay with 3d modeling and animation. tuenti produced a number of new opportunities, affinaty wasn't exactly what I was looking for, etc. each time I get redirected from objective destination (where I think I want to go), it's just another evolution-of-desire -- az I've come to see that all of those things, like silvia was to valentine, just steps along the way to coming to understand and appreciate myself, *instead of needing technology* (or anything else external to myself) *to compensate for my defficiency*.
