...
- another thing I noticed just now is "de furturivis literarum notis" by giovanni battista della *porta*. I noticed that "portra i Dvre" looks a lot like portia (from merchant of venice) to me. portia is the lawyer, which is cupid's final form at the end of the golden ass.
- the 'o' in "honorable" has an opening in the top -- and isn't like any other 'o' seen in the whole piece (reminds me of the frontispiece for decartes "principia philosophiae": https://upload.wikimedia.org/wikipedia/commons/f/fc/Descartes-2.jpg -- look on the bottom ICC, CIC).
...
- the 'T' and 'P' are also the same shape on the cover of hamlet's second quarto in "THE" and "Prince" (but not the first quarto) -- I know that's a standart font, but where it's used is important, like the big 'A', 'Q', 'P', and 'T'

29:09 - this reads "rex for d" (king 4d, king for dee) to me
