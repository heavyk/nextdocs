...
I represent the second category there. I didn't know about this thevetat guy, as that's probably the serpent mentioned in rev. 12 and in genesis, credited with "deceiving" humankind into believing that they can obtain direct knowledge *without* being initiated.
...
the eventual goal obviously is to see what jason has to think about it.
...
with that way of looking at it, you could say that a child is an intermediatist (or an underdeveloped adult), a blind person a positivist, and a person capable of perceiving the astral, a sort of blend between the positivist and the intermediatist.
...
let's imagine the worst case scenario here and suppose that they do figure out how to maintain a monopoly (by creating clones or a sort of controllable human being) and they manage to create infinite handlers and have a system of controlling them -- well, at some point, our genetics will continue to evolve and improve, meanwhile theirs do not. conceptually, because we've learned how to feel the way we want to, our bodies will become incompatible with their vibration, and so eventually they'll die out because of an inability to maintain their immortality by transferring into a new body.
...
### eagle pecking the liver of prometheus

I just noticed when he said that liver is forethought, and prometheus is forethought, that zeus, the eagle is trying to get at prometheus' foreknowledge or insight into the future.

when he said that I had an image come into my head where I'm prometheus, and the eagle (nosebook) is pecking at my liver each day to gain insight into my foreknowledge. that's probably the function of these documents and also whatever it is that they do while I'm asleep.

### weaponisation of singularity technologies

in the last section of this interview, there is a discussion on how do we create a world where these zero-point energies can exist without people using them to cause harm.

first of all, I believe that the current trajectory that we're on of being "bound for freedom" is a good one, where the powers that like to control conditions have full control over conditions. as I mentioned in the previous section, I see pretty easily that there will be technologies that allow everyone to live a fully modern lifestyle with all of the good stuff that we presently enjoy, however we may be withheld from a lot of these other "singualrity" technologies and those will be controlled by a select few. it's even possible that they're going to continue to use those sigularity technologies and the advancements in genetics to continue to manufacture more and more bioweapons that they use on us to continue to keep us without the conditions that threaten their superiority.

all singularity technologies are a threat to their superiority, so they'll be suppressed obviously, but as we begin to collect together and develop our own technologies for ourselves (no longer needing them), this will be the struggle that we end up at. I'll continue this idea in the next section.

anyway, the thought that I had about jason being very concerned about the weaponisation of singularity technologies, is that first of all, the ones in charge have time manipulation capabilities, so any such event would get reset, and you could eventually imagine that at some point when singularity level technologies become available to them, that person is then put into their own timeline, so whatever damage that they do, they'll only do it on their own timeline. if a person wants to blow stuff up, no big deal, because it dosen't affect the rest of us. they would have to take that technology and advance it a few decades to be able to manipulate timelines to be able to affect anyone else. I just don't see someone dissatisfied with their present situation in the world to go to all of that effort of developing the technology further, identifying the other timelines and finding a way to affect them without the other timelines just splitting off.

they can't harm because if I have timeline technology, you would think of it like tuning into a timeline with a machine, but in reality timeline technology is a state of mind, or a form of perception. it assumes that I've mastered the ability to exit and enter bodies, so if someone did manage to blow up my body on this timeline, I just tune my consciousness into a different timeline and then make a split so that the guy blows up another timeline. once you've gained the conceptual capacity, you really are immortal. it would be impossible for someone to ever destoy me because I would just tune into the timeline that I want. I'm completely free, but to get there I have to gain a level of consciousness that cannot be accomplished with conditions. the part about having them control all of the conditions is creating that form of consciousness. I really am, "bound for freedom".

### the singularity

I'd like to talk about how I see the singularity now, because after this many interviews, I feel like I give my perspective on it. I see two main phases: the phase leading up to the singularity and the (individual) phase afterward. in the phase leading up to my/our individual acquisition of singularity technology, I am certain that the ones in power see that as a threat to their superiority, and so therefore they will try their hardest to prevent it. we'll have a number of biological weapons (like covid) that will be continually released in effort to reverse any advancements that our own genetics make. as I mentioned, I find it very difficult to imagine that all of these world leaders will ever be able to agree on anything and there will be large amounts of in-fighting and factionalism this prevention of others will destroy most of these "world leaders", and there will be a pretty large turnover in that group. only the most capable of ahriman will survive the continuing increase in conditional capability. each genetic enhancement will be coveted weapon that they'll engage in constant struggle to attain.

then, anyone that figures out their own singularity technologies, I feel that once no other possible ways to prevent their attainment of this technology, I find it most likely they'll be put into their own timeline so they can't affect others, and each of those timelines' technology advancements will be harvested by the factions of controllers. these guys will constantly be in battle between one another for the most control, and that's perfectly good for them, but for us, this will be entirely invisible. either they have figured out (using their technology) to stay out of sight from us or they've figured out how to use their technology (nosebook) to completely reduce all aspects of human psi capabillity, it doesn't matter. we'll have technolgoy, but it'll be mechanistic and not related to psi. that'll be stifled of course, with the ones that break through, obviously put on their own timelines.

the rest of the humans here will live a bit of a different style of lifestyle, where we become more emotionally focused where how you feel (well-being) becomes dominant. it's also a conditional approach to reality, and I have a feeling that life will have a "supra mundane" quality to it, which means it's a mundane existance, but the graphics are enhanced so that people are happy (kinda like movies and video games). it's possible there could be some crossovers to their side through the secret societies and stuff.

I believe this (supra) mundane lifestyle will push people to look to begin to feel how they want to feel, because I know after having interacte with various people with fame and money, that it doesn't satisfy and make you feel good. no matter how good the conditions are, there is still an aspect of you that will still be deeply unsatisfied with reality. no matter how much they block psi capabilities, increased dissatisfaction still attracts, and I think it'll start to become recognised amongst people that unhappy people cannot be satisfied with conditions, and so trying to "help" them is kinda a losing battle. since they have to make that decision for theirselves, it's pretty unlikely people will want to include them in their communities.

as a result of this, most people will begin to tend toward a lifestyle like mine where I'm not too worried about what everyone else is doing, as they don't really determine how I feel. I attract my reality, so any attempts to, say keep population low or to reduce mental capacity through genetic weapons are all fine to me, as they don't really affect my trajectory too much.

so these guys attempts to try and hold everyone away from singularity technology will ultimately be the alchemical process that means that everyone on the planet here will be attracting what they want.

extend that idea out further and it means that we'll all be on our own timelines sometime in the future and once we've all developed sufficient timeline technology, we'll find each others' timelines and share and reintegrate aspects that we like. the olypian gods could potentially still be in a parent timeline looking down still harvesting all of our own technologies, but they have no capability to bother us, so they're no longer a threat.
...
I have no idea where the manu concept comes from. I assumed it was zarathustra because he's the origin of the messianic concept, which later became maitreya, christ, etc. -- I think -- or, perhaps that was derived from a mithraic idea. not sure.
...
I can't wait to experiment with it, because if you were able to copy all of the atoms of the body of another (alive) person, then you would get all of the DNA and everything, but what if there was a way to copy everything *minus* the nucleus, so no nuclear DNA, and so the dna that the physical will get created inside of the electrons nucleus, will be a reflection of the physical aspect. we can make anyone look any way that we want by airbrushing the carbon atoms to have the desired (3d) colour and (3d) texture. because it doesn't contain the nucleus, the dna of the physical part will reflect the physical, which opens up a lot of research and exploration of the physical coding parts of the dna (touching no part of symbols, concepts, and desire). THEN, when the body is sculpted and perfected to the physical shape and size, a group of riders will move their consciousnsess into the body and the desire, symbolic, and conceptual aspectx of the incarnating entitiess becomes a reflection of the incarnating entities in DNA form. again, there's likely a lot to study there too.
...
### 2022-11-12 02:08 - no thing is true; everything is permitted

all things are relative to the observer, including truth. the observer is a (unique) point in both time and space, and also includes a *conceptual structure* through which it perceives its world. all things that perceive their world only from the physical, are base elements which have an emission, transformation and absorbtion function proper to their elemment type and its configuration. this means that things like rocks behave exactly like those kinds of rocks behave. they are "pure" functions. us, though, us humans, we're different, which is fire -- a connection to the non-physical granting us the ability to attract a reality where our desire (slightly different than will because desire is for a feeling and a will is for a physical configuration) has beecome a reality. it's so intoxicating to be physical because that's where all the action gets really real. in the conceptual, they're all the perfect forms/realities that they are, but it's the limitations of our physical reality that force this reality to become slightly different; slightly imperfect. that imperfection produces more desire. iPhone 26 will roll around inevitably as we're insatiable now.

everything is permitted because everything is attraacted. you say to yourself, "well, what if I were to just behave in a way that's way different than how I behave now" but actually try to do that thing. can you? I doubt it. you say you can, but can you really pull the trigger? it takes a lot of emotional strength the override the personal desire to go the "right" (preserving) way. the way that preserves what-is, is the way that is the way of righteousness. the desire to be right is the same desire to to preserve, so *actually try* and do the things you say you intend to do. you'll find out after much trial and error (or at least I have), that I only do the things I *feel* like doing.

I've fully embraced such an entitled brattish of a perspective. I've also fully embraced materialism as well. this is nearly parallel in direction to everything is permitted, but from a perspective that looks more like petty aesthetics, rathar than petty allowance.

you can't possibly get it wrong because it's all attraction. the "worst" stuff you could do to someone, you're actually only doing to yourself. you're always only fighting yourself and your own concepts of reality. are they boosting or are they weighing things down. you know those high performance guys? they inspire me, but the thing is I don't like all the effort. I really like reality as effortless, so I'm looking to figure out effortless high performance. the journey will produce many advancements in how we interface with technology. someone has to run the test to see if the rat can run the maze with which half of the brain.

can you imagine how ridiculous it is to tell people they could not disect the human body? this is the opposite of everything is permitted. under the rules of everything is permitted (usually this only happens during times of war, so extreme brutality and testing can be accomplished during an existing time of brutality and loss of life), which strangely enough, is actually what brings about scientific advances more rapidly.
...
when I create an egregore, I create it because I want to prove a reality. let's say I'm miserable and I summon an egregore to do something bad to me to prove to others that I'm miserable (or any other emotion). basically, every time that we're fake, meaning we have to "prove" an *emotion* to someone (I'm happier than I am), we're giving power to a concept, which then becomes a reality in the form of a real person, which then "proves" the reality to me. I can look around to others (and others to me) and say "I told you so". we "knew" (a function of memory) it. the realities that can happen are the ones that exist in someone's mind -- comprehendible to someone somewhere, emotionally. we tune into them conceptually.

these imaginal realities (like sara) then begin to group up into realities conceptually similar to our own. this is our concept of reality and it's our "memory" of what was. "we" are timeline going toward what we attract. we live in a giant clump of concepts. if the physical didn't exist, concepts would attract really rapidly (ns from our perspective). as an example, it could take months, years, decades or millenia for a concept to arrive to you in the physical layer. somehow, I have to *find* the person and translate one conecpt into symbolic language capable of activating a memory of the original concept in the other person.

at the furthest point away, there isn't any similarity and so only physical vibrations occur (or lack thereof in the case of atoms), but if the frequency is similar enough, anything can be tuned into. the astral (imagination) attracts concepts obviously a lot faster than the physical, but you can imagine how fast the coneptual is (being based on memory/feeling), but is still no comparison to ultra high frequency of attraction capble from the 4th ray (fire) perspective, where everything about the concept of what I tune to is understandable by me. this is LOA in a nutshell right there.
...
### 2022-12-04 10:44 - a brief disucussion on memory and what makes sense

when I write these things, I'm using a part of my brain that is something like memory. my memory is composed of concepts rather than data, so my concepts are far more stable. in a ccomputer, you have an address to its location in memory, but you don't, unless you run on a modern operating system which puts rules into place on who can access what memory. those are artificial protectiions that we've made in the physical implementation of the concept of mentation. in reality, there are no such limitations, and even because there is so much chaos/desire out there, environmental conditions are even hostile to the preservation of that data. for me data is unreliable and unsafe to use because it'll go changing on me, and I have no idea of it. this happens to me all the time with memory, where somethting slips around and memory of it is far from accurate (usually going in the direction of good), so I'm quite happy to not have visual memories, becuase of how much this data (the stuff stored at the memory access) can and does change.

as a result, my memories are based off of concepts, and what that means is that memories are accessed based off of feeling, so any memory that I can now *feel*, I can "get" the concept entirely. I was entirely ready to understand mcluhan when I read the first part of his book, and so I got the whole thing. it was one of those things where I thmought, "oh, I already know all of this" and didn't feel like I needed to keep reading. this has happened to me on a number of things, one of them being the sirian guide and the corresponding kuthumi's extraterrestrial view of creation. it's a narrative that is entirely compatilble with jason's memories. in these situations, I feel like I know what jason's talking about, tesla is talking about, kuthumi, or the amanuensis for dtp. these all feel the same in that the concepts that I feel when they're speaking, allow me to access these memories as well, but I do it on a conceptual level.

in fact, it's not really making so much difference if it's a news story, or a fictional story, a song, or a short movie (or both), I *can* access that mental space in a non-visual way. this is the new form of memory in action. you've seen it demonstrated, and it's memory based on concepts. I'm like a universe now, where things can exist inside of me which I don't have concepts for; and, like the universe, because I don't have concepts for them, I don't perceive them.

a universe is a lot like a human in that concepts that I don't understand cannot be seen by me. they can still exist, but it requires something external to me to allow me to begin to see that new thing that I wasn't previously able to see. this is novelty for both humans and for universes. this is the inheritance of our selfishness

and "only concepts I understand exist in my universe so I need someone/something outside of me to see something new/novel" is also the foundation of this new type of memory, because for me, the only things that exist, are the memorable ones. I've divided this into 4 parts: el/la belief/unbelief. therefore, if it's going to be remembered, "it makes sense" or, it doesn't. the common hum-drum mundane stuff doesn't get remembered, so the entire world looks constantly new to me because I don't see/remember the common or mundane stuff anymore. it's true that there could be entire worlds of things that exist in the mundane form of perception, but I can no longer see this.

I find this view to be quite fun and can swich in and out of it, so you'll notice that a lot of my jokes are about the mundane, because the mundane looks so comical to me. as such, one of the "fun" things I like to engage is, is ultra-mundane things like factory work, pulling weeds, most computer tasks, all computer games -- and let my mind wander while I'm doing that. I have very litle (physical) concept of what is happening, but my mind is elsewhere. this contrast of engaging fully in this other universe I call the conceptual.

from what I gather from hearing lev talk, it sounds like this world that I experience non-tangiblemente in the physical does have an somewhat physical and visual counterpart. you may not have seen it, but what has happened, is I now have 4th ray capabilities where I can see or feel anyone non-tangiblemente from their perspective. their perspective is valid, because I have no resistance to say mine is the "right" way. instead, my perspective is the one *that makes the most sense* to me.

so, for example, I take the memories that jason tells, and I see what he's saying, I find it valid because it *makes sense to me* from a vibrational, everything's connected (2nd ray) perspective.

therefore, I just want to be clear that these are not accurate, but they seem at least plausible to me, and so in some way they make sense. I think I'm actually one of the first humans to have reconstructed the past from the perspective of LOA -- actually, I believe tesla had -- and, actually, I think the leader of jason's atlantian dissenters (saturn), probably had looked at things from a LOA perspective as well. probably vulcan as well.. yep, I'm definitely not the first. it's intereasting, because all of these guys I believed self-sabotaged by defeating therselves with their own concepts. oops, derailed.

what I intend to do is to explain these memories from my perspective, accessing the memory *conceptually*, and explaining them from my perspective now.

one of the things that jason also believes, which I find interesting is that he thinks the mars/atlantian regime is a time-traveling super race. he see's the oppressive ownership aspect to it, but I see it producing the most adaptive (novelty producing) species yet to exist in the universe -- and, as such, I believe that everything from the original martians/atlantians was all an installation, and kuthumi's narrative of the INFECTED ONES the narrative structure of this iteration... this is one of the successful ones. self-adaptation means our progress is infininte, meaning we're the root-3 line down the centre of the cube, cause we can adapt both the past and future simultaneously. ... if the civilisation that installed our species into this star system was a time-traveling civilisations, this thia is (or can be) an edit to get an improved/more potent trajectory into the future. if it isn't already, it can be. we can modify our past to remeve all resistance. no resistacce means the shortest path, which is root-3 diagonal on the cube. I'm ambitious, you might say.
...
### 2022-12-04 13:53 - 1st ray stars (part one)

the antithesis to novelty is habit -- therefore, we must consider the "enemy" to expanding perception as those who are of the habit of makiing everything constant and stable.

the primarily visible/tangible dimensions of perception are the odd ones. as such, the females tend to like these. however, if you notice the triad arrangements, the only one with a female in a secondary view (as in astral or fire), was isis, a 2nd ray. she taught women how to be stars (have solar perception), which was vastly successful as an evolutionary improvement for females. they were seen as large, abundant, and very giving (like stars are). this allowed females to be basically controlled by the star (a 2nd ray, isis). they became her sorta like "servants". the 2nd ray perspective is one of desire and also mentation. from the 2nd ray perspective, it doesn't matter where the desire came from, it's compatible with me, so as long as my definition of me continues to remain compatible (either more or less), then I continue to desire it, and thoughts, ideas, pictures, then finally manifest as a result of the 2nd ray perspective. I'm either gaining compatibility with the desire or I'm not. this is the solar perspective, and so this allowed men to begin to desire in a new more logical way, which later externalised itself into a new people group that called theirselves the aryans, represented symbolically and also astrally as the 7th ray triad.

since the beginning, they have been maintaining our physical plane from an astral perspective. this is why the moon is so important, because they don't want anyone to be able to "see" outside of the moon's orbit. this is their astral "prison" if you want to call it. this dimension is empowered by the sun (2nd ray), and so that is her perspective, this has passed through the 4th ray perspective of our own mentataions as a human species (the  collective imagination), and many of these mentations pass into the physical, with enough mental intensity (or suitable/fortian atmospheric conditions).

as such, the tangible dimensions are the 2nd (solar), 4th (collective conscious), and 6th (imaginary)... some are beginning to learn now of the 4th, and they, like me have unlimited access to all information that's available. the 2nd (solar) perspective is the way to understanding them.

imagine two boys and a girl. the girl is a 2nd ray perspective and she just loves to find a way of thoughts to turn desire into reality. one boy is the astral perspective where he's all imagination, combinning feelings (emited by the female) into physicality. the other boy is the 4th ray perspective where he has access to anything, and so from that perspect he can tune into the girl's feeling and perceive the mentation (3rd ray) aspect to it and also the conceptual. since all mentationns (4-7) are aspects of the 3rd ray, the 3rd ray appears to know all things within the domain of the two contexts of the concepts emitted by the astral boy and the female. when you understand the female's perspective, you get the "whole picture" and everything appear exactly where it should be. that position of perception is one of complete effortlessness -- because understanding everything is to no longer have resistance to it. there are things that can obviously be improved, so let's just do it... duh.

### 2022-12-05 14:16 - another angle at tesla's memories

I'm going to render the same (though probably updated) concept as yestereday, but this time from a different angle.

first, I must define what I mean of timelines and the future perspective of the attractor at the end of the timeline.

imagine yourself in the present and you have a set of "memories" which are little markerposts in your conecept of what "happened" on your way to the present moment. we call these "memories" but they are our best way of piecing together the fragments of this "memory" with our concept of what is believable to me. this concept of the past is essentially what creates the present, because you have to be "right" about your concept of the past. you'll notice that a dying person, through physical processess like altzheimers(?) and stuff they lose their "memory" of the past because their present concepts have changed too much for that to still be recognisable (in the normal case), but for them their body has developed a case which is disconnecting (by losing their capacity to tune) to those outdated concepts. when those people's bodies die, they let go of those physical concepts incarnation into physical/astral go and the concept, the pure eternal resistance-free conceptual form[^1]. that release feels really really good, like the biggest orgasm of your life and your transition into the non-physical (that living blackness) is magnificently pleasurable. like an orgasm, you don't turn back because it feels so good. one who has failed to get back into non-physical can imagine that this is something like stopping the orgasm hundreds or thousands of times. it'll be quite a sweet release.

anyway, your memories of the past are how you think you got here to the present. however, can you imagine a "worse" or more unlikely set of circcumstances to get me here. as an example, my life is filled with novelty everywhere I look, so the reality of my life being unlikely is an understatement. novel is unlikely, but novelty like I play with is far beyond unlikely. I don't get any pleasure or meaning out of being unlikely. for me the most likely thing is that the unlikely thing happens. that's why I know all of this fanfare and stuff is about like the rennaissance armies "fighting"; endlessly making manouvres until both sides got tired and called it a day. no progress will ever be made on that ever because I know that I end up having the unlikely thing happen. sometimes that's good, and sometimes that's "bad". it really depends a lot on my perception, as you've probably noticed by now :)

anyway, imagine for a moment that you wanted to adjust your trajectory so that worse things happen to make it even more unlikely. it probably even takes some years maybe decades or even centuries before the concept is successful. it's my theory that the echo of technology *is* the promethian desire that still echos forward from the destruction of tiamat, this desire will be fulfilled, and along the way enki notices there are these echos of this other force. he calls them fates and destiny, but what he's seeing is the echos of prometheus' failure propagating forward in time as sorta repeat scenarios. in lbe[^2], enki is beginning to start to see the 2nd ray (promethian) perspective, where he can begin to see these echos of this thing that is kinda neither fate or destiny, seemingly appeared to him like a tidal wave coming out of the giant disaster in time. in reality, it's something a lot more like attraction (ie the destination of that tidal wave is attracting the wave, and there is definititely some collateral splash damage).

anyway, imagine for a moment in 20y or so (2038) that I decide that this run through the physical was too easy. you can see how I might say that because it is, and I'm not really all that challenged, so what I decide to do is to take all of my perceptions of the past and pushed them way further out in my life, so that my realisation of what I realise now doesn't come till much later. like let's say I don't finally get this concept until 2037 or something like that, leaving me only one year to accomplish everything I will accomplish from now until then (not like physical data, but conceptually/emotionally, meaning I *feel* the same as I do at the destination of the attractor). then, for me, I live out that (more difficult) reality and so I think that I had to overcome a whole lot more to get there, which means my inertia/velocity/momentum is greater and so therefore though I'm in the same spot, I have more charisma.

when I go back and make a new past trajectory for myself and then jump into it fully knowing that I'm *guaranteed* (some people doubt it, because they don't understand attraction) to arrive to the same moment I'm in when I tranferred out, just coming now from a different angle. btw, the more times you do this, the more angles you can see yourself conceptually as -- prolly good for more dimensions.

anyway, so what happens there is I get to continually put in the hardest difficulty settings for myself, and they somehow look easy afterward. I think it's a game to me.

---

the thing to notice here is how to create a "worse" timeline of yourself (which feels to me like I've been mixed in with tesla a bit myself) -- so, when you create these "worse" timelines for yourself, you're intentionally self-sabotaging your past by getting people in the present (or past, but before the worse timeline ends) to have dreams of, memories and other such astral (ficticious) imaginations of things. the astral is just your imagination, and it's how you see the physical (through your imagination) so everything you think is "real" (all senses) in the astral can be artificial. this is really good for creativity because it means that others can be implanted memories to attract a worse timeline for yourself to incarnate into.

the thing is, kids grow up believing these imaginations to be real, because they were so vivid, when in fact they are nothing more than other astral content, sometimes created and sometimes someone else's imaginal form (like the entities floating around in dream state -- those are all imaginal entities created from sufficient mental energy).

anyway, I'm not saying that jason is wrong, because he's not. in fact, because that reality was really vivid and real to him, that was the past perceived which this moment includes, so it really is past history for him. we all share a reality, and we think we all got here from the same historyline; we did not. that's what makes so much of our interactions so funny is because we're interacting with timeline versions of "ohers" and ourselves as the most intense (discoordant/haronious) of interactions. this happens naturally over time, and anyone who has seen "addictive behaviour" will recognise the optimisation for intensity.

the most intensity is derived always from the most difficulty, so if you're a real performance guy, you'll optimise your past. I'm just saying, that if I'm right about LOA and the universe and my concept of how non-physical (subatomic) interacts with the physical, then you're going to find far greater returns on optimising your past so that you continually have harder and harder dificulties. the more difficulty the more pleasure -- and you also trust yourself more and like yourself, and stuff like that. it's terrible.

[1]: the mental body as opposed to the astral or physical (in dtp words).
...
in some sense, I desire the traditionalist perspective as for its capacity for me use it as a foundation to build new concepts on. one of the things that you'll notice is that for me (and others I'm sure) is that concepts build on each other and eventually form to become this enmormous mountain of a thing that would take pages and pages to write it all out.

when we think of this kind of explosion of data which would take thousands of words to describe a picture (ie the imaginal) -- this does not compare to the additional orders of magnitude of words necessary to express a concept of mine in its entirety. the further problem is that in the process of writing it out, the concept updates, changes and improves (which is why I repeat myself so much). so, by the time that I get to the final of the first version, the concept will have evolved, often times so much to be unrecognisable from its original self. this is the insanity felt in the psychedellic experience, where things seem to loop forward or backward into another between related (but not necessarily opposite) meanings which can generate the concept. these loops of meaning are how fashions, trends, and other "viral" things tend to spread, because they fulfil the frequency of the meaning of the evolution of the conecept. they tend to have a periodicity to them based on different things that serves as conflicting interests, the exploration of these loops as a system of periodicities becomes the the new movement of stability -- if you know what I mean.

for example, imagine that you have in fashion the interest of its parent culture to be productive at work, but also to have leisure at home -- well, fashion comes to the rescue here and makes it acceptable for certain fashions will satifsy the comfort (fashionable) to be in this situation (with this brand's clothes) and feel comfortable -- the image presented in the adverts.

the stereotypes experessed in fashion and home culture as presented as an extreme sets this imaginal picture (family matters, home improvement, etc.) and they tend to fail for their obvious failures. no serious family can operate like steve urkle's house. neither will smith's or any of those other ones. the prototype was too silly and people's home life was quite different than that silly perspective on american home life also garnered a bit of hatred from other cultures as well. we're giant posers. as such, the shakey foundations of the various trends that exist in a culture (fashion, food, luxuries, high culture, etc.) are all the food for the next trend. so, something as ridiculous as the 90's put us right in a perfect position (from a fashion and culture sense) to have the world say, "grow up and get a grip on reality. it's not like it is on the TV."
...
if I think of belief as something that's possible, then on some level, all the stuff I believe in will have a mechanism for it's apparition in our experience. one would think then, if I can beleve in it, then naturally, there will be a way to deduce its mechanism "logically" -- meaning, there will be a system or formula which can be used to predict it's manifestation with some accuracy. (this is largely the case with quantum physics. we believe the evidence and so therefore one day we'll have a way to describe its system for manifestation).

hypothesis are different from from beliefs, but not by a whole lot -- with the only difference is that a hypothesis is a belief with a mechanism attached. the mechanism makes it look more real. we then believe in that mechanism (like phenominal authorisation), and it appears that this mechanism becomes the "habitual" manifestation for our reality (ref: sheldrake).

finally, a concept for me is the essence of something. that "essence" of the thing is it's "frequency" of emination. a concept itself is not the thing but the thing that gives the thing its essence. for example, a stool is functionally similar to a table, but the concept associated with a stool is something to sit on and a table is something to set things on. the concept of "something to sit on" can be anything from a stool to a chair or sofa, and "something to set things on" could also be a chair, table, sofa, counter -- whatever. there are a lot of overlap between concepts, and the direction that you look at the concept from (your origin time and space, culture, experience, etc.) determines what aspects of the concept you can see. they're very spectral/intermediatist.

as an example of manifesation of a concept into physical, imagine a fractal that places atoms according to a number of different parameters, each of those parameters also being a concept (so think of DNA, arms, legs, eyes, organs, etc.) those parameters can be changed to make it appear different too, like a stool getting bigger top part and longer legs now is a "table". different parameters can be "table" or "stool", so the concept itself is definined either externnally or internally (by the observer), and not absolutely defnined by its parameters/aspects.

since all concepts are recognised and observed by the observer, it's often the case that two may observe the same thing and definie it differently. those differences, can be thought of as beliefs, because they are many interconnected conecepts, usually based on experience. experience is remembered (at least for me) in conceptual form, and so serves as "evidence" for the concept's definition in my frame of reference.

---

so if concepts are kind of spectral in nature, where one concept can also be another (like a table with small top and short legs being a stool), and that perspective is now "validated" by experience, which are also concepts, each concept itself is a "soverign" view into reality from the perspective of the observer (and their conceptual evidence for why it is what it is).

"I know that's a table, because I've never seen anyone with phsical proportions to sit on that, and if they did, it'd break the legs" (as an example) -- and so there is always a way to get a sort of logical reason from someone why something is something. sometimes that logical reason for why something exists (especially before you can talk), is because you saw it somewhere (like on TV or in a book). phenominal authorisation builds the conceptual reasoning for something to exist in their reality, as a sort of experience (which are concepts theirselves).

you probably have noted here is that concepts can create experience (especially in phynominal authorisation), and also that experience creates concepts, which can we seen as eviedence or justification for concepts. the way you observe and define your reality, is circularly defined, and so therefore can be thought of more like a liquid than a "solid" foundation. all society and cultures are this way.

---

I want now to go back to the concept of a concept being a "sovereign" view into reality, because those things shape what we expect. for example, if I walk in somewhere and mistaket the tables for stools, I could expect a giant to come sit down. stools, tables, and giants are concepts, but sitting down is a symbol or action performed on those concepts (5th). those symbols/actions/words/path (3rd ray) are what happens to those concepts according to our belief (what the conecepts are) and experience (how they interact/symbols/). each observer "authorises" manifestations/interactions according to their concepts/symbols (beliefs/experience).

look at this idea on a galactic scale and it's pretty easy to see that these patterns create resonances, orbits, spinning things and such. I'm not entirely certain how to explain this properly right now so I'll leave you with an incomprehensible paragraph (that I wrote stoned) which explains it quite poorly:
...
trying to fight against the promethian perspective by contiually believing that the imaginal or pictoral is "forethought" is a massive misunderstanding of what forethought (and the fire of prometheus) is, which is the strong desire to be *right* about the things that concern us. the problem with relying on these pictoral predictions is likely to be gross inaccuracy. tesla's imagination was pretty accurate because he focused his imagination to perceive things as the physical does. you can also tune your imagination to see concepts (ask lev). the inaccuracy is that the picture diguises and even distorts the underlying feeling. a good guide is for any prediction is: if it feels bad (angry, discouraging, depressing, frustrating, etc.), it's not likely to happen unless you make it happen *because you want to be right about it* -- which is the masculine aspect to the 2nd/3rd ray's perception of belief (of being right about it and so therefore I'm attractive to the reality I'm "right" about).

---

it comes to my attention that in addition to the masculine and feminine perception of belief/unbelief, I feel there is a 2nd/3rd ray difference of how those look. OH, I see... the feminine perspective is now the 3rd ray perspective, but this was not always the case. enki/sanatau setup a system where the 3rd ray is masculine perspective. I wonder how that would be. one sec.

OH, I see. I'm going to get a direction wrong, I can feel it, so I'll just relate the parts as best as I can see them. the masculine principle at that time was based on proof, evidence, or justification. this was in relation to the 3rd ray, which is all aspects of our mentation, so from the perspective of the titans (enki's perspective), the basic stuff that we consider reality (4-7) needed to justify itself in order to exist -- this means that in the perspective of the titans, the solid stuff we consider reality has to jusify itself to me in order to "exist".

you can then begin to understand the importance of having a symbolic perception of reality. all the stuff that matches the symbols, is justified as reality. therefore all of reality behaves in accordance with the symbols that have been used to describe them (belief/unbelief). for all of these gods, everything appeared insid of enki's reality matrix perfectly in accordance with the symbol. the big picture was finely tuned to be working perfectly, however it was an operational perspective of one's trajectory into the future and is bound to eventually fail if unknown circumstances are encountered. in reality, the big picture is the connection between the originating concepts combining to become something new. this connection always yields an unseen vibration of desire, which influences movement toward something by seemingly "going toward it" -- when in reality, it's coming toward you. I never moves. "I" am always at (0,0). I emanate from 0 and that emanation is desire. it influences things to want to come toward me.

---

anyway, it was interesting to see why enki's still stuck in the stone age after seeing it from his perspective. for him, nothing is jusifyable, cause none of it makes sense. all of us, and everything is supposed to follow a specific pattern, but it's not doing it entirely/perfectly, so nothing makes profound sense to him. they still look like physical/astral actions and reactions though, as he isn't able to put a symbol to a lot of the things that happen. it's something like going to zero-g environment, but it's more like being in a foreign country and not understanding wtf is going on. reality is meant to be understandable.

I don't mean in any way to say that enki is stupid, as his concepts are very complex and not in any way primitive. I was referring to the "box-consciousness" sort of setup, where "once it's tuned and perfect, just maintain it" sort of outlook on life. what he's got works good enough for him. he looks at us and understands a good portion of what is happening, but doesn't have a framework to understand it like I do. when I say "understands" -- I mean that other way of looking at it, because remember, in his perception, reality needs to jusify itself to exist. something consecrated or sacred has more jusification for existing. for him, there must be a mathematical formula to describe when something can exist or not. he's looking at our reality as completely unjustified, chaos, the work of antu. our world looks like one of pure chaos and desire. you know, I suspect he's probably got a better grip on things than we can imagine. when you get used to looking at frequencies, it's pretty easy to recognise the desirable ones.

it's really hard to talk about this subject cause I just look at the concept and relate what I see. I'm not making anything up, but I feel like it's weird or something -- but know, if anyone has any questions, I can probably get a conceptual answer.
...
### 2022-12-19 04:28 - prometheus and atlas is aiming to deconstruct a world order that does not yet exist

this entire interview is somewhat painful for me to watch because money (funding) almost never comes with a pure beneficent perspective. investments are made to make either more money or to secure more power, so it's kind of a battlefield that I don't really want to be on, because you have to play by the rules of the money and the organisations that run the money. I guess you could say it's fighting fire with fire. philosophy, I think suits you much better to bringing about more real actual change...

that said, this statement about trying to stop a nightmare from happening by saying that the work of philosophy "prometheus and atlas" is an attempt to deconstruct a world order does not exist yet, is -- well, let's just say that this statement made all of the previous parts of the video make sense to me.

from a LOA perspective, you can't give your attention to unwanted (the nightmare) and then try to solve it with good intentions. even though they're good intentions (or bad ones), the focus on trying to stop or deconstruct a looming future, only intensifies that future. if you were succussful in deconstructing the future, it would only delay its manifestation.

in a sense, what you're doing is playing chicken with the future, saying "you're either going to take me out and have your way, or I'm going to get my way and delay your manifestation".

all futures are attracted, and so if that's the future that is being attracted by those putting more intensity into the future, such as this jonothon character with his esoteric and occult activities, these guys are doing rituals and magical stuff to try and put as much energy into making those futures happen. usually they're stronger than the average joe nobody following the mainstream narrative. these occultists will continue to be able to attract the futures that they want because they put more energy into them than the average joe. it won't be until the average joe actually knows what he wants (in an emotional sense -- which comes out of experiencing unwanted), he won't be able to actually attract a future that encapsulates the concepts he desires.

the only real way to get the average joe to attract a future that has a certain set of concepts in it, is to put those concepts into his reality. this is your concept of phenominal authorisation, because most people don't know what they want until they can see it. we didn't know we wanted hoverboards until back to the future, for example -- and so for a reality which includes hoverboards, we need a society that can allow for such antigravity technology (whether it's magnets or whatever).

---

I want to talk about this idea now from my perspective. I have tons and tons and tons of really great ideas -- but nobody actually sees them like I do. I can talk about party-LAN and people look at me like I'm nuts and say -- "what wireless power? on the human aura? you obviously don't know physics" and they poopoo the idea because that concept is completely foreign to them. even if they could see the idea from my perspective, they don't know that they want it. others, will find it threatening for whatever reason, because whatever freedom that someone may have appears as a loss of control or power to someone else.

I simply cannot be bothered to try and make others see my perspective, as it's impossible for them to know they want it until they can see it for theirselves. in order for them to see it for theirselves, somebody needs to fund the idea and engineer it and produce it. those things are controlled by the current power structure anyway, so it's unlikely to be able to convince the power structures to make that idea a reality unless it increases their power and control. therefore, good ideas are never going to happen unless they can increase power and control of those squabbling over power and control. from my perspective, those sorts of things will only happen when there's no other way into the future without that thing. somebody have to want it, so it becomes an exploitable market.

to demonstrate the idea, let's take the concept of wars. wars are very profitable because they're so expensive. we can want war, but that's about like not wanting nintendo or playstation, which are also massively profitable. it doesn't matter how many people don't want nintendo, if people keep buying them, there's a market for it, so nintendo stays around until something better comes out that's even more profitable.

because of how much desire controls the market, I've shifted my perspective over the years to not try and fight for something that people don't know they want yet. it's just not worth the effort. instead, I give all my ideas to the power hungry now, and then once the idea is out there, it's just a matter of time before someone says "hey, I want to do that too".

a good example of this is neurallink(?) -- and I'll have to ask elon about this if I meet him, cause being able to operate my computer with my brain is something I've longed to do for quite a while now, but it seems like it wasn't until "the network" (which is a power structure) came out, that people began to realise that it would be really nice to actually be able to operate things with the brain and see the screen more comfortably inside of the eye. I have ideas on how to access the brain wirelessly even, but obviously that sounds extremely scary for some -- so that probably won't actually be considered until the wired versions pose some sort of risk or concern that it'll be even considered.

I have wondered from time to time what it would be like to swich my "hat". I mentioned a guy "fwh" which I thought for a long time was myself from the future -- and it's often puzzled me the name "*former* white hat" -- because I guess I would think of myself as a white hat now. I have tons and tons of optimism for all of the great things that can be done (kinda like tesla with his world system), but nobody knows they actually want my ideas (like I said above). so, what if, instead of painting all of my ideas in a positive beneficent sense, I started to talk about all of the awful things that you could do with my ideas -- and I think tesla went through this phase as well, with his "death ray" -- trying to sell war machine ideas to the controlling forces instead of benevolent ideas which would improve humankind.

what if instead of a white hat, I switched over to a black hat, and actully started to come up with ideas to exploit and enslave people with the current technology, to try and make the good ideas appear more favourable to those in control (a sort of obsolescence of present technology)?

this too, I think is probably not going to be very effective either -- because *it's all attraction*. I can only attract toward me the things that I want, and then others seeing what I'm getting/creating/attracting, will produce in them an idea of what they want (after they get past their "I'm less than" mentality). victims stay victims until they change their concept of reality. no anti-gravity, iranian renaissance, or any physical change will change a person's concept that they're a victim of reality and handed the things that the authorities give them. they will continue to attract a reality which reflects their concepts, no matter how hard I try. I can only go my own way and do my own thing. that's literally the only option.

if someone were to exploit me along the way, it's not a problem, because it's all attraction anyway and I will eventually get what I'm attracting, no matter what (remember, attraction is concept based not physical thing based, so you attract based on feelings and how you "know" the world to be -- like a victim *knows* that the world is out to get them and certain people can't be trusted).

OK, so let me give an example. my perspective now is that life is constantly improving. I don't really look toward the news media or whatever to tell me that it's improving or getting worse, because then my attraction is in their hands. as long as I keep noticing improvements, that's what my reality consists of. powerful people *could* try and limit or constrain those improvements (ahriman), but in general things continue to improve and that's all that matters. my reality is a reflection of my concept that things have an ebb and flow, but are always improving. I can't control any specific manifestaion of what exactly is improving, but things are constantly getting better. that's all that matters.

sure, there are things that annoy me and stuff, but those are things that happen and then I just let them go so they can improve. if I keep focusing on their broken state, that is how I conceptualise it to be, and so it must continue to reflect my concept of its brokenness/annoyingness.
...
stable, yes, static, no. I feel very strongly about things not moving faster than they're able to go. -- which is why I want to find ways to stably and safely go really fast -- as in a society capable of keeping up with rapid technologic advancement/development.

> and they justify that by claiming that their form of society is a microcosm of some divine order

I claim that everything is a reflection of its parent concept -- which, now that I'm approaching this from the perspective of seeing everything as a medium, it's easy to see that all things in the medium have a sort of minute reflection of the parent vibration upon which the medium is created. now, whether that medium is *actually* a reflection of a "divine order", is something that I would encourage a critical analysis of.
