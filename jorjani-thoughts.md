...
when we think of this kind of explosion of data which would take thousands of words to describe a picture (ie the imaginal) -- however, in contrast to this I would say that it would take a new orders of magnitude of words greater to express a concept of mine in its entirety than any singular picture could take. the further problem is that in the process of writing it out (which is why I repeat myself so much), the concept updates, changes and improves. so, by the time that I get to the final of the first version, the concept will have evolved, often times so much to be unrecognisable from its original self. this is the insantiy of the psychedellic experice, where things seem to loop forward or backward into another (not necessarily opposite) concept, sort of how fashions and trends tend to have a periodicity to it, the exploration of these loops as a system of periodicities becomes the the new movement of stability -- if you know what I mean.
