...
so, really this upgrade is sorta to exist in that forethought and afterthought universe. you know I don't really control many of my thoughts anymore. thoughts come and I just sorta find ways to feel good about them. living almost excclusively in that zone between thought, I find myself constatntly feeling good or bad about what I just said, so mostly I'm just listening to myself talk, because it's a major source of good-feeling when I recognise some enlightening thing I just said; it's kinda a drug.

it's kind of a new way to think honestly, where I just let the situation work itself out just how I feel about it.

### 2022-09-30 11:05 - timewave as a 2d perspective of the alpha/omega

I don't really know how to explain this concept so well. I may struggle because it's the very first rendering of the idea.

when I looked at any atom, I could see that it had a cyclical vibration to it, but also an amplitude, which I equated with DC biased AC. that vibration repeats over and over fractally over different durations of time -- meaning that you'll see the same vibrational pattern over 1 time unit as over 64 time units, and over 1024 time units, etc. each octave repeats the same sequence. terence decoded this sequence using the i-ching as a method for working out the 64 different "angles" the novelty sequence could take. this produced a fractal wave that was self-similar on every octave (doubling of frequency/time).

you also know that I've claimed that roughly ~1kya the present solar regime was put into place, and that solar regime encodes a "concept". I claimed that before the current regime, the concept was physical-reality-is-everything. at the peak of that regime is when jesus showed up. his "death" was important because after that physical-reality-is-everything begins to wane and because of his interactions with the romans, the new concept of mutual-back-scratching begins to emerge. I claim that mutual-back-scratching is at its peak right now (hence the reason why I see sales and marketing becoming the new "authority" from now on) and even right now my influence on society is beginning the new regime which I've identified as the concept feeling-purposefully.

I don't really know the mechanism for it, but it seems to have something to do with 2nd ray energy. I believe that the i-ching was something that one of the great mysics of that time figured out to be a pretty good aproximation of the frequency of that concept.

---

the thing that I don't really know how to explain is how the wave is both cyclical and also accelerating. it's likely something that I don't understand with EM/wave theory, because I can see that the frequency starts and end at the same position, so it is cyclical, but because every octave has the same curve to it, it appears to me that as I zoom out, I can see the resulting magnitude of each moment, adds up to be more than it was previously, and so the wave, after some time runs off toward infinity -- at which point, consciousness has gained enough momentum that a new alpha/omega shows up and encodes a new concept, reflective of the consciousness that has emerged. that new concept is always (let's say) not in direct opposition to the previous concept, but it looks about 90(degrees) perpendicular to the previous concept, because both of these concepts are going to be waxing and waning simultaneously, so they can't be completely in opposition to each other. it looks to me like "turning a corner" (going a slightly different angle/direction) rather than battling over the same path. the waxing concept helps to conclude the previous one (like a chapter in a storybook), meanwhile the waning concept aids to "perfect" the waxing concept by ensuring that the waxing concept cannot recycle the old concept directly (it would completely self-annihilate rather than expand into more), and so conflicting vibrations (when they're going opposite directions) annihilate each other, and so therefore all that's left are the harmonious bits (when they're going the same direction).

it'd be fun to model this, because even two different dualing expressions of the form y=mx+b (self-similar at every octave) would produce quite an interesting result. what I *don't* know how to do is to create fractically self-similar waveforms, though because I seem to be able to produce them (or at least pretty good aproximations of it), it would be an intersting thing to look at, especially considering integrating this concept with the [series of mechanical oscillators](/statics-updates.md#2022-09-21-1823---dial-in-the-frequency) idea. the reason for this is that it looks to me like a fractally self-similar wave (or a pretty close aproximation) would have very dramatically amplifying effects to it. I wonder if tesla took that concept and applied it to electricity rather than to statics. that (I'm trying to do a randall impression here) *could be perhaps* another way to look at the tunguska blast[^1].

[1]: reactions wants me to explain what I mean. the surface of the earth (geology) emits an EM(?) vibration of some kind, which I believe is pretty constant, but most powerful when the sun is rising (hence the vitrified stones in various megalithic sites), and so that is one of the waves. this wave needs to "dual" with another wave, which could have been produced by a meteor entering the atmosphere (the waves coming off of the front of the asteroid look like the waves of when you blow across the top of a bottle or around an airplane wing), and that can perhaps interfere with the vibration coming off out of the surface geology to create imense heat (kinda like perhaps the chicago fires). the reason why I included tesla into the sentence there is because, if tesla was vibrating the ionosphere in a dualing way with a corresponding frequency coming from the surface of the earth (there was a reason why he had such a grounding system below the wardenclyffe tower), in a way that was similar to the mechanical oscillator, it could produce a comet like result. inotherwords, I don't believe the meteor/comet needs to impact to produce a vibration which could reach an amplitude capable producing other secondary effects on other frequencies (light, heat, sound, etc.) -- it just needs to have that self-similar fractal wave property and dual with the present concept (surface geology) to produce a those secondary effects.
