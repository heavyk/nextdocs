...
you see, I'm not very competitive, but I am certainly ambitious.
...
### 2022-11-11 16:48 - giving my attention to what I like or punishing bad behaviour

I'd like to begin by saying that there are disadvantages to both (perceived from the perspective of the observed), namely that if I give my attention to what I like and I really see amazing, around me, those people will do great (if they can allow theirselves to be great in the parennial sense) things, and I'd like to add they'll do signifcantly greater things than me because I'm at a severe disadvantage -- but the this is really a state of mind that one takes on, and one begins to have no matter the conditions. when I go away, that condition goes away and they revert back to their old selves -- well, these people will make an evolution on theirselves. it's always that way; in fact, it's what I did. using my example, you can see that I went from a really high frequency to a much lower one. this is usually what happens to girls, and so I had an experience more similar to a girl than a boy, which historically sex rituals and things of that nature were used for men to gain a high frequency (as in there are some girls that are really high frequency which some men use to maintain a higher frequency and more youth).

the disadvantage to punishing bad behaviour is that in every case it produces a losing scenario. when I punish bad behaviour, I'm giving my attention to the thing I don't like and thereby perpetuating and strengthening it. you know a lot of kids (and you can probably remember yourself even) deliberately doing (or not) something because they wbere punished for it. it creates static programming that only matches on a small set of circumstances and deems the rest of it fear -- that great unknown of impossible to predict reality.

therefore, what I do instead is I take a much more neutral approach to things. I'm really trying to limit my expression of excitement, gratitude, amazement, wonderment, or any of that stuff. people find it tremendously annoying and I'm not really around kids, so it feels really really weird for their low novelty lives to see an adult that still has wonderment and excitement (zest) for life. therefore, I try to minimise it as much as possible.

instead of giving my attention to things (or punishing anything), I try to understand the perspective that's behind it. once I understand it, the thing can keep happening (because it's very seldom the case that I can do anything about it), but this time, it doesn't bother me anymore. it can exist in my environment and so what ends up happening is the child, perceiving their own vibration (instead of my vibrational reaction to it), they end up feeling the dissonance in their own vibration, rathar than the dissonance in mine.

### 2022-12-29 17:01 - some crazy theories

@[youtube](https://youtu.be/xo_fMcSLp7Q?t=1407)

in this video, jimmy is putting out some crazy theories, and so he's got my mind spinning. it all starts with that quote up on the screen there. it says that old english was spoken in britan from 450 to 1150.

well, as I've mentioned in other places, my theory is that an entire ~1000 years have been deleted from the record. there was this bulgarian woman that I saw on youtube (don't remember her name now), but the theory is that we're in the era of christ, so all dates starting in the the new era (since the birth of christ, as opposed to the previous year count) were prefixed with I -- from ISVS (jesus). it was easy then to just say that I450 is now 1450 because they look pretty similar.

so, when I saw that quote there, I had a thought (amongst others I'll share below), which is that old english is entirely a fabrication that a whole network of famous authors created around I450 to delete 1000y of history. to understand what I mean there, isis is the sun, so when jesus is called ISVS, this is another solar symbolism and they love that stuff -- so when it's the prefix of I, this is talking about a *solar cycle*, and so if this theory is correct (I'm seeing more and more evidence for it all the time), that means that we're in the solar year of 1023 -- which is one year short of the solar cycle, which I claim is 1024y long.

I'll let you draw your own conclusions there, but for me I'm a bit confused by it becaause the numhers don't line up very well. looking at the gliesberg cycle and other things, it seems pretty obvious that the peak will actually be around 2048 though -- so doesn't line up cause that would be that the solar peak is going to be next year, rathar than ~25yfn. so, I don't know.

continuing that line of thought a bit, it would be interesting if what's happening is that we're merging timelines with another. I've talked in other places about my theories about how I experience definitely some very different things differently in my memory (like 9-11 incident, nobody died), and so what I'm seeing in my mind is -- imagine two timelines. one is at 2048 on the slow timeline -- and then there's another very fast timeline (the one I experdience) where tons and tons more terrible things happened (this is black hooded guys spraying disease and other difficulties mentioned in "gods of eden").

the theory here is that the more difficulty one experiences, the faster they grow (should they allow theirselves to grow). normal people die under the stressful conditions, but the fast timeline has the highest concentration of hardy people on it (weeds), and it's these are the guys that survive easily through plagues and hazardous conditions (like radiation from nuclear testing). the group of all of these weeds are so much hardier, their speed at going toward technical advances is much more rapid as a result of the difficulties (they have to make better tools, more solutions, and solve more difficulties). this is, at least, true for myself -- though I believe it to be a universal principle (more energy in the equation is always more energy, no matter how you look at it. energy cannot be destroyed; only transformed into something else).

in the slow timeline, there are lots and lots of secrets and things that have bad optics on them, so they can never be admitted or verified (like how many *really died* in 9-11), so the veracity of those events will never get a truthful "official" answer to them, which means they could be anything. my recollection/belief of 9-11 is just as valid as another. same with my idea of a missing 1ky. therefore, now imagine that somehow we were able to get the fast timeline in the same vibrational medium as the slow timeline. they will certainly blend with each other, but the more energetic one will become dominant as their frequencies ([like metronomes on wood](TODO: vertasium video)) begin to converge on a new frequency together. I'm visualising a sort visualising myself now as a more energetic timeline hijack.

welcome to my timeline :)

---

the other theory that this video insired me to think about is because jimmy is showing the antipodes map and talking about how isostatic flexing causes one thing to rise while the other to fall. me used (on purpose, I think) the idea of one antipode rising while the other falling. I don't find that immediately possible because I see the earth[^1] as a tripartite being. it has the land upon which we stand, which is the 7th ray female. then there is a cube star in the centre, the 1st ray female. around this cube, there is a distinct red glow and haze that gives the cube an appearance of a star. this is the 7th ray male and why we share so much in common with mars (we're a "red star" as jehvih calls us in OAHSPE). we're a spherical resonator, so I don't immediately see a way for one side to push others. instead, what I see is a shape that has a number of teeter-toters (rigid vertices and bendable verticies -- I can't see how many but I'd say a low number like 8 or 12). what it looks to me is that these are the fulcrums where the isostatic flexing happens right -- so it's more like a triangle than a line.

the lines, between these verticies would be something like that vertical sea going down the middle of the sahara. if that was low and filled with sea water, and then rose up, it would push other parts down. I can't see details like that. I can only see the concept, which is that there is a fulcrum (the ground) and then the other sides of the triangle ... I don't know what I'm seeing. I don't have enough knowledge of something to describe it[^2].

in general, the way I visualise the earth is having a sphere around it. well, a sphere is kind of like a bubble, so in that sense, maybe I can see one side affecting the other (like how a bubble wobbles).

a sphere is every point that is some distance from another point, so I'll consider it a sphere, having a bit of a density and a thickness to it -- exactly like the ionoshphere. it's just layers of spheres of greater density going down. we intuitively think this, believing that the earth has a core, so we think that the point of power or attraction is a point -- but I claim that the "point" where the spherical layers eminate from is not a point, but all of the points that are some distance from another point (the star) -- so we're livving on top of a hollow sphere. it looks like it takes in some energy (prolly from the sun) and reflects it out to all of the points some distance from the inner point. these emination points from the spherical resonator create densities. the thin layer we call the surface of the planet has the highest density, so it's spewing out rock and minerals (probably all of the elements, actually) at a rate reflective of the input signal (prolly the sun). this would create, like on the surface of the sun, a number of very complex interactions happening inside the middle of the surface layer. the result will produce bumps and mountains, and all sorts of irregular but "natural" formations.

I can also see that this ultra high density layer probably isn't a perfect sphere. you know that I subscribe to frank chester's 7 sided figure as a resonation pattern for earth's geometry. obviously something like jupiter and saturn have an even more complex density layer pattern to them and theirs is much more visible in the gas -- so it seems likely to me that the spherical shape of the surface is the result of a geological process, not the shape of its resonator (just like jupiter and saturn have beautiful/amazing vortices at their polar vertices).

[1]: again, this is one of those secrets that the veracity can't ever be revealed, so it *could* be what my timeline has, and it *could* be what it really is, but neither the fast or slow timeline is allowed to know what it *really* is, so it could be either. in my timeline it could be the way I see it and on your timeline it could be something different, which is why we're sharing the same timeline. you're tuned into your environment, right so if I'm only allowed to see 100 of the 1000 items, I'm tuned into all other timelines that share those same 100 items as "reality" no matter how "true" they are.

[2]: in general, this is the difficulty of a conceptual mind, which is that I can't talk about things I don't understand. when I don't understand, I repeat what others say, and then when I "get" it, then I can talk about it from any angle. this topic, amongst others is something where I can see something, but I can't tell you what it is because I don't understand it. I actually learned about this noticing people telling me untruths. I could see something else other than the concept that they said (usually a person emits a similar concept to their words), so the words help me to fill in the gap, so I know what they're talking about, because less than half of the population do not emit complex enough concepts that I can understand them without listening to their words. I often say, "what?!" like when I saw that quote, because the words are not matching what I see. I have to stop and write about it often to be able to start understanding what I see. the merging timelines and old english was entirely made up was what I saw.

#### 2022-12-29 18:21 - what if jimmy's idea is also right?

@[youtube](https://youtu.be/xo_fMcSLp7Q?t=1486)

now, he's talking about the "island" of atlantis could also be continent or peninsula. just imagine how much our language affects our descriptions. we say atlantis was an island, but this is another problem where its details have vested interestes in keeping everything a secret, so it really could be anything as well.

he has a timeline where atlantis is in africa and let's say mine is majority where it was an island. we're both in the same timeline and I'm watching his video on where it is, because the details have been purposefully obfuscated. thanks to some changes in language (like shakespere definitely did), can redefine such a concept making it more vague ("island") -- so really it's the authors of our reality which determine how people got to the present. I belive it because the history books say it's so or jimmy provides a compelling argument -- or whatever.

so, now imagine a thing where the planet spawns people on timelines which are believable (egregores), and so our reality is composed entirely of things that fit the accepted history. by allowing atlantis to be any number of places on earth with equal validity, we're allowing 9-11 to be whatever too. what this means, is that a good portion of conspiracy theories *are* true and also untrue at the same time. if that's the case, incarnate humans are a collection of all of the possible and successful[^1] histories that could lead to this present moment.

in such a situation, where we all have different timelines/histories that brought us to the present moment, it's no longer a matter of who is more right than another. we're all right, and we've destroyed ourselves in the process of trying to get our frequency to converge in the medium of time. all timelines of earth are converging towars a stable one, but we keep disturbing it with new crackpot ideas. I'm probably the worst.

[1]: successful because of grandfather paradox. you can't come from a failed timeline/history. you wouldn't exist otherwise, so it's kinda like proving that you are by existing. I exist, therefore I AM.
