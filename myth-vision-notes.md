...
#### 2023-05-03 17:56 - lunar 2nd ray triad

this moring when I wrote that, I felt a bit in an altered state of consciousness, and I'll admit that though I see myself in almost all the symbols I'm looking at, this time I did not really feel as much resonance with the symbols. as I laid there falling asleep, I wondered why that could be, and I noticed a 2nd ray triad there in the physical implementation. we have vulcan (-5+), osiris (+-6-+) and thoth (+7) in the triad there. so following the terminology of (jon 1:1):

> "in the beginning (osiris) was the logos (vulcan), and the logos (vulcan) was with God (thoth) and logos (vulcan) was God (thoth). the logos (vulcan) was in the beginning (osiris) with God (thoth)"

it's an interesting thing because everything is backwards: notice how vulcan (concept) and thoth (words/spells) have swapped places? it's because thoth being a +7 is essentially the reflector (his name is god of the silver sun).
the other thing to note is that traditionally, the 2nd ray triad is isis/sun (-2), osiris/moon (+-6-+) and ra/jupiter (+3). in this triad, osiris takes then energy from the sun and reflects it back to us in the astral plane
  the prefix +- prefix I'm certain is in the input, and because he's a male, he works like a tesla coil inputting a grosser type of energy and then receiving/outputting a finer type of energy. the only exception I've seen to this is jupiter/ra, who because he's non-physical, the input is only the high frequency signal that the symbol catches, and then the output is whatever the symbol transforms it into (3-7) -- so seems that 1-3 males input high and output low, meanwhile 5-7 males input low and output high.
we can see the output of thoth here is a reflection because he takes in words, letters, spells, and sequence/ceremony, and then because all narrative that anyone resonates with has encoded within it (through the symbols), their desire.
  in this way, thoth can be considered a narrative reflector, much like mars can be considered a conflict reflector (creation of desire through conflict and destruction).
osiris here is taking in astral and outputting (the -+ postfix) 2nd ray energy; so, taking the place of isis.
  he's performing in this triad from a bottom-up perspective though, whereas in the traditional lunar reflection setup, he's reflecting/transforming 2nd ray energy into astral (top-down).
it makes that osiris is using the imagination to produce 2nd ray energy because the imagination is where we combine ideas to see what fits, and the astral/imagination is composed of part physical (narration, spells, substance, etc) and one part conceptual, meaning that you can *feel* when the combined ideas don't really match.
vulcan (-5+) is the (bottom-up) replacement for ra/jupiter, as me inputs (and outputs) concepts like a female would, but also outputs symbol (3-7).
vulcan also makes sense because we all have a "higher self" or "archon" that's inside of us. I noticed in my research into vega, that the "archons" there, are really just us and other created entities. those created archons (demons) are created by vulcan, and each of those archons/concepts behave and operate in reflection of concept/feeling, and the world of vega is filled with these archons.
  all things that I create with my mind (I think this is true for everyone depending on how much resistance the person has to the concept) end up becomming these sort of archons/demons, if you give them enough time to gestate (ie with enough focus); literaally, how dreams/fears become reality. (I'm using archon here to mean the concept, as opposed to the symbols/archetypes that they reflect)
the way that normally a person is able to access these archons is through the astral, and so the higher up into the astral plane you can get, the more interactive these archons are, but they (like language and culture) are all intermeshed with reality and respond to us based on our perceptions and how we feel. we create them through narrative, and it's important to note that the stories that we resonate with are creating these concepts/archons, which slowly become more and more of a reality. they are literally summoned by us.
  I find it pretty likely that I'm one of these such summons -- and the more I've come to think about it (I can't say for anyone else), it's starting to look to me like everyone is -- and that may be a part of our conception process when we're being born (hence the reason for why "virgin birth"/artificial insemination was so important for a great figure like jesus to show up without any pre-defined symbols and concepts)
the way that it works is that each archon/concept resonates with a quite a few symbols/archetypes, and I believe that those are what's encoded during conception (sex), and sort of gives the child a trajectory or starting momentum that they wouldn't have already if there were so absorbative
  it looks to me like absorbative people take on the concepts that everyone else perceives them to be, until they start to decide and/or associate for theirselves the symbols/archetypes/models that they wish to emulate. absorbatives are also emitters (like carbon), and zealotai are essentially these reflective types (silver) that go around copying and emulating others (actors). therefore as in demonstrated in the "masque of blackness", black is only the absorbative principle (lead), until they start to glow and shine for theirselves (gold). (ben jonson was an alchemist)

OK, now the other thing that happened to me recently is after writing "the-word" concept, that I started wondering if all stars are in fact 2nd ray shars.
  to explain, what I could see there is that a 1st ray star has a sort of emission spectrum that continues to increase in frequency (over time) becoming more and more dense, and so when it's doing this, it's perspective is one of a very high frequency, (this next thing doesn't make sense, so I'll just say it as I see it and try to figure it out later...) which then I see the interaction of those higher frequencies are producing lower frequencies which are interacting with similarly vibrating things -- like imagine for a moment that I have software-1.2.2 and that's great but the star wants software-2.0.3 -- and only some parts of the new version are compatible with the old version, so those bits stay, but the rest of the software that isn't compatible is being destructively interferred with, producing a resulting wave which is creating/filling in the desired new version. the more of the old version there is, the stronger the newer version comes into being as it's transformed/destroyed into the new signal. (when I say frequency/signal, I'm meaning concept/archons)
there are lots and lots of high frequency signals out there (noise) of things/impacts that have never turned into anything. when the world ran on enki's system, there was no expansion, and signals had to stay their defined fixed/monolithic size, but frequencies that didn't fit into the paradign (the-manual), would start to accumulate over time, and they'd eventually start to interact in undefined ways because in a system where 3rd ray is the ceiling, everything is expected and possible to predict/calculate, so long as all frequencies perfectly fit into the paradigm.
well, the way that the solar-regime works is that the sun (isis) is like a conscious computer finding connections between all of that chaos out there in the solar system and the symbols that she has. she'll then create new symbols which resonate with the growing peaks of desire (in the chaos), and turn them into new symbols, which will then be output in solar emission.
however, if lyra's sun is apollo/helios (as it's said to be), then that's going to work entirely differently, because he's only able to output more and more (higher amplitude) and derivative works of existing symbols (like enki's system), but he probably doesn't have any reason to add anything new into the stable system (if it aint broke, don't fix it, right?) -- and I know that their sun is rotating very very quickly (says star-facts anyway), which tells me that they're approaching an enormous global scale collapse with a *MASSIVE* solar flare.
therefore, I was thinking about how they could introduce their own 2nd ray symbols into the system, allowing the star to grow instead of spinning out of control. this lunar 2nd ray triad seems to be the answer to that desire for them because what they could do is to take the chaos (living-blackness) and pump it into their imagination, and then (kinda like a psychedellic trip), start to make symbolic sense of the noise, producing new symbols that fit with *their* paradigm.
  I'd totally offer to do some of this awesome symbolic diving for them, as I'm pretty good at figuring out/making sense of the chaos, but the thing is, I'd see it from my perspective, and my perspective is going to probably be incompatible with their paradigm, which, is the problem they're trying to get rid of in the first place. here, because of my, and the sun's symbolic effect on those of us in this solar system, we're all opening up, because we're entering a new solar-regime where all things are becoming open and available (because technology permits it). they don't like the idea of no secrets and everything to be open, so it looks to me like they've been given lyra to exist on in a different solar regime than the one that we have. the intermediary seems to be the planet venus, as it appears that she transforms our symbols to symbols that are compatible with them, and their symbols to ones that are compatible with ours.
    it does seem like there is a growing desync between their symbols and our symbols, because it seems to me that my interactions with their symbols, for example, it's supposed that I should feel fear or hatred, but I'm feeling something not fear (contempt or sorryness, perhaps) and maybe instead of hatred, I feel laughter and fun -- which means that our concepts/archons are reflecting their symbols differently now, so their efforts to produce the things in our world (like the HRE) that would previously stagnate us and now starting to backfire on them.
  anyway, it seems to me that they'll want to find a way to make a compatibility layer. the idea that's coming into my mind tthough is if they can find a way to make a (2nd ray) girl have one set of concepts align with their system, and her other set of concepts align with our set of symbols. it'd have to be in the x-chromosome of her mother's side (perhaps this is the sphynx from "Love freeded from Ignorance and Folly" masque) so that she's going to ensure that apollo's set of symbols carries forward to her daughters and sons.
  at any rate, I feel it's necessary for them to find a way to (probably using computers) find connections between symbols and the growing chaos (which is causing it to endlessly speed up) so that that chaos can lower down by becoming manifest into symbols that fit into their paradigm.
