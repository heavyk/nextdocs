...
I like foils myself, quite a bit because any time that I'm overly optimistic, I want people to try and take me down to a more realistic level. in a way, zaryn played that role for me in tuenti; he's carry on endlessly with me about how doom was just around the corner because "facebook will translate" and/or we're running out of money (or whatever). his incredible realisim was a huge downer to my unbounded optimism that I had for the idea of making a social network. his negativity fueled me (me also being a foil to him), to prove him wrong and actually make a profitable website, and find solutions to his problems.

there is a tendency for someone being foiled to cause them to become a charactor or an actor, by needing to prove theirself to the foil. this is what happened to me with zaryn, as I, without realising it, started to need to be *right* and prove him wrong, than I just knew my own capacity and just continued to work on what I felt was the next step.
...
I'm very certain that the companies running the COVID vaccine have remote access to the body, so they probably have my genetics anyway. with that, it'd be possible to reprogram cells of the body. we'd have to talk to bill gates about that one, probably. it is possible to mass reprogram all of the cells (I mean it happens during sex anyway). the cells that those vaccines produce would be sort of reflectors (uniquely shaped to conform to your id number), so using a broad spectrum sort of analysis, it could be possible to figure out the reflecting (carrier) frequency of each body, and then using those reflectors, it could be possible to begin to mass reprogram the x-chromosome in all cells of the body to match mine -- sure. that seems like a good idea too. that also sounds pretty effortless as well -- unlike like ferdinand and hercules's epic labour.
