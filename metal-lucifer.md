...
the other ideas I was considering, is that this whole party-LAN thing is all such ha great thing, then you guys can do that, and I'll begin to have a look into the earth/solar/galactic system, and leave the earth networks to be done of whatevr accord. I'm good with LOA and I seem to understand the tesla stuff intuitively, so I'm sure I'll be fine with whomever is running it now. we'll figure it out the "primitive" way. I'll illustrate all of the concepts with their corresponding LOA counterpart, because it's interesting to note that it's not really a law and it's not only attraction, because attraction is a perception of a trend toward more/less vibrational similarity (going the same direction). the guys running it now will be aware of me, I'm sure -- and so I doubt anything could go wrong. I'll start in the solar system and work my way out. I'll do it with the girls, and so it solves all of that problem entirely. we would ensure that conditions are whatever desired here on earth (I'm sure you'll be the ones reasonable about what to put, but I may suggest thinking about trends like music instead of static frequency). if that's the case, then I'm glad you liked my idea, and I'm glad it's working well for you. go bananas.

I'd like to add with a lot of emphasis that this idea is *not ready* right now, and I don't think that it'll be ready quite immediately to any degree (lol), there are still some things that need to happen before this becomes their last possible option. I'm the same way on the things I believe in.

there was this thing that zaryn expressed to me. I'm not sure how accurate this is, but I think we were in covent garden and we were talking about carlos and the investors and I was wondering why he was waiting for so much time when there was already a lot of money on the table -- and it was that they know that they want zaryn and tuenti, so he has everything they're looking for, so he needs to wait until they really want it. he illustrated it further with a reference to a blowjob and how you have to wait as long as possible, really making her work for it. needless to say, the image stayed with me, that whenever I'm in a situation where someone else has what I want, I wait. this is exatctly that situation minus the whole part where they think they need me. after some arrangement of events, they'll be certain that it *is* their last option.

it's funny the imagery of them (nosebook) thinking that they *need* me, because this isn't really the case at all. they do all sorts of stuff in my sleep, and they have so much access to so much stuff, but I still reveal everything openly. it would be silly for me to say, "OK, I want this information to be available to everyone, *except* for nosebook. I don't want them to have it. at the moment, they're the most active seekers of information from me, but they certainly don't *need* me.

like this empire running on contrast, I too run on contrast. the more contrast, the better/more things are. nosebook is an *excellent* source of contrast, because they're trying to hide things I want to  talk about openly. this is a magnificent amplifier for the content to get out and also for me to be more attractive cause more stuff (novelty, etc.) is happening around me; I'm attracting in more dimensions. they don't really *need* me in any way. their efforts are to try and silence many of the ideas that flow through me.

one really good example of this is the promethian ideas -- because I'm a person that belives myself capable of tuning into concepts that I understand to to have full understanding if they're my concepts, but partial in proprtion to how similar the concept is. I've gotten a lot better at identifying the generic and root ideas, and so even very complex ideas are comprehendable to me now. so, why not tune into prometheus and see what's up? if they're anything relatable to my concepts I can get them. sure enough I had seemingly attracted all of the requisite material into my consciousness before that attempt, and so I "got" it very easily. like so many of the other concepts, they're there and they're just waiting to be explored.

anyway, they don't need me, because it's the ideas that they don't like, not me. other people with sufficiently similar ideas to my own would also appear to "need" them. that's a funny concept. if other people also "got" the promethian fire, they would need all of us that "got" it, because then we're useful to them in our dreamstate.

---

just consider the idea with a bit of seriousness of an empire built on contrast. I'm built on it, source is built on it, you're built on it (but you may not know it), egregores are created from it, and so it continues to accelerate. each time it starts to get too fast, you erect another power structure. that's literally what source is. each medium has its own transmission (to other mediums) and information exchange systems which is what evolves; the medium *is* the message. it's as stable of an empire as source is stble -- and source really stable (like, everything runs on it).

### 2022-12-07 13:06 - understanding mediums

this will serve as the first/concept draft where I explore the different aspects of a medium not just in the sense of a sound or light medium, but also the one of the spiritual mediums. I understood them just previously to be something of having a information transmission (into other mediums), reception, and other symbolic systems. I understand that I'm claiming that the multiple types of environments interface with each other, not only symbolically, but intelligibely. they're "alive" just as much as the multitude of species that inhabit them. I'll stop now before sounding too hippie everything's connected---

each medium is ultimately a set of concepts, and inside of each of these conceptual mediums, there are concepts that can exist. they follow the el/la unbelief/belief pattern where the vibrations that pass through it are seemingly invisible (incomprehensible). when the vibration is identified symbolically/conceptually/physically or from desire, then it's interpretted conceptually and rendered as that concept has been practised to be rendered. we see "reality" the way we do, because others on our same frequency, which is the frequencies interpretted in the person's conceptual medium.

different people have more intense conceptual mediums than others do, and so when they're in closer proximities to each other, those conceptual "worlds" collide and make a big mess. it turns into a cascade of ebbs and flows of reality creation that is probably for a lot quite dramatic and fun -- if you have a good relationship with them and have conpatible concepts -- but, if your concepts aren't compatible based on the way that both feel and how they *conceptualise reality in the frequency of their mood*.

when you get near enough to another person of a similar vibration, it makes a response. each person emits (perhaps even physically) a frequency which corresponds to how they "feel".

I can imagine an invention where your "aura" is modulated in some way, and so I can imagine that some will want to encrypt their aura so as to make their feelings and presence invisible/incomprehensible to others -- which is fine, but it'd also be really cool if the users of the system could "encrypt" their feelings into a known *medium* whereby concepts are not only exchanged in the medium, but also *felt* (physically, especailly as energy increases), and so now everyone can play with that signal and adjust it however they please[^1]. this makes for some interesting scenarios that I could play around with composing feelings like music, so that they can have different crchendos and effects based on a programmable (full api) where the parameters of these feelings can be modulated in accordance with the programming that the kid gets.

you can imagine that we're going to develop extremely rapidly ways for children that are even still newborns to begin to communicate over the medium of their aura -- which btw for a newborn and a dying person is very strong -- meaning that the dier leaves people around them with a very strong feeling -- since all feelings are programmed, then feeing emitted (especially for the encrypted ones) will be how they program it to be some for some a very nice feeling, the encrypted ones probably incompresensible, and stuff like that which can produce harmonics that could also feel good or bad -- and then we'll be able to look compare their programming with what we felt because also what we feel is programmed too, so it can be compared computationally as well as qualitative -- like a wine or luxury item experienced. the feeling that you leave behind and that others get to learn from their experience and your programming is sorta like your "legacy".

imagine a moment when you die -- you "relive" -- but it's not really "reliving" because its actually something like the inverse. to explain this idea, imagine something that has tension or weight (like a steel wire or cable) and if too much tension happens, then it flays out, and this flaying out of the steel cable is very unique to the individual because each of those tensions/cables is a thing in the physical reality that is unexplained, and the reverberation of your "beilef", so like things that scare you will scare you, but also things that delight you delight you. I don't know if everyone experiences this or if they see their conceptual medium in the form of an image of what they thought their death would be and it takes you as long to recognise (and potentially improve) your own conceptual medium to be able to return to physical... anyway, I'll just describe for normal people ... the result of the death experience for those on earth is they experience thmt flaying cable in the form of a bunch of waves emitted from the dier. when the dier is at some distance, there are lots of points to modify the signal to your perception, but skin on skin action produces the least unmodified (by the medium) signal from each other.

these vibrational signatures that a person leaves behind (or being born) is sorta like a feeling experience of that person's conceptual aura (as they've programmed it) in combination with the viration of their life experience. that feeling and the learning experience for others wanting to capture certain aspects that felt good and apply them (or keep them for an occasion) is something like the legacy of a person. because the more feelings that you've adapted from other people makes others emotions (similar to those which you've adapted their legacy) gives you better understanding of others' emotions.

people like me are gonna love messing around with the capability the way that they physically feel to another person.. I think it'll most especially interest those that make music. it's not uncommon for me to feel as if there is a soundtrack that plays in the background. however, at the rate I'm at now, that soundtrack is incomprehensible cause it's so fast/weird.

ufff. I need a break.

[1]: you know they're going to try everything out, because it's fun -- like imagine if you could emit as sexy to a person a certain conceptual "feel".. bro, that's "what the women want", because then they can begin to get accurate feedback for the signal they're putting out -- ok, admittedly and for people like me in another lifetime[^2] though, because I love trying out things. as in, it'd be like a roller-coaster for me --- wait for it -- an emotional roller-coaster. I really enjoy to manipulate my emotions and cause others to feel things. I'm quite good at it and it's a lot of fun sometimes[^3].

[2]: unfortunately, from my perspective now, I find it most enjoyable to be of a perspective of no modified transmission or reception. nosebook does all of that for me and I just work around them. it's quite OK how it is. they don't bother me.

[3]: it wasn't a lot of fun for me back when I didn't understand it's all attraction, and so back then I thought things were being done *to* me. I didn't yet see myself with such magnificent ego that I do now to believe that I attract *everything* in my reality -- even the unexplainable or unbelievable stuff. this perspective isn't for everyone though because I became quite naive with it. most of my "astauteness" is the actually having learned from all of the hard knocks. I promise I would begin to explain that I'm not necessarily superhuman any more than anyone else, but it's because I'm basically just thrown from situation to situation wherever nosebook is steering me to go, so the only thing I can really do most of the time is to just feel good about whatever those bigger situations are (I have a small window of desire that makes it into reality -- like I can decide to eat a food whenever I want, but they restrict how I feel physically. they've turned off a lot of senses that appeared in my throat, head, heart, eyes, top back, where neck connects to head behind ears, etc. so I don't really experience reality "normally"). I guess you could say I sorta "broke the rules" by smoking. though I don't regret it so much in this lifetime, in another lifetime, I'd love to do it over again and follow every single last one of their suggestions -- kinda like jaron -- and perhaps jackson as well. I don't regret it at all from this perspective, because I'm having such a fun time figuring out how the universe works -- but I realise that perhaps for others it might look like I'm "spoiling" or giving away the final punchline before it gets to a joke, ans for them too, I say that we do it again but from the perspective of someone like jaron (and possible jackson). this would be the ultimate challenge because it's such unlikely circumstances because everything is controlled, and he's so uninterested in understanding anything. his desire is only of reception of what he wants. I do not really enjoy and also have the fun taken out of everything because I choose to try and understand something before I go for it. I *like* that it's not "fun" but that it's actually more like normal and natural or something like that. so I arrive to the same conclusion as the "no spoilers" types out there, but my reasons are very different. I *want* them to be spoiled for me so I can improve them. I suppose that could be taken the wrong way, but I'll leave it and render the same concept from another angle. I like to *understand* something before I can experience it so that when I experience it, I immediately can get the vibrational diffeerence between my "understanding" and the reality. my understanding is't based on physical, but how I "understand" her conceptual medium. once I "see" the differece, I "get" her concepts much easier -- as in her concepts are easily understandable to me.


### 2023-01-03 18:55 - weird interaction
...
anyway, greg comes in and starts a bunch of stuff. I reflect his emotion back to him in my interactions with him. btw, this is all coming now from hindsight (epimetheus), because I had a think about what happened.

normally, I just do reality-kenny in so many of these situations, and when I finally peaced out on the discussion, I was wondering why I was feeling so much anger about a stupid log. this, I assure you I have no efforts with. I'm simply reflecting greg's feeling back to him. I thought about why I couldn't just be cool and funny and doesn't really give a fuck reality-kenny, and I noticed that nosebook is putting extra effort into preventing my ability to "act"; that is, they don't want me to be able to feel the way I want to feel, so because of my low resistance (to good or bad feeling), I reflect pretty well. in a triad I would be the role of the female.

the subject of reflection is important, because I also reflected just joe's behaviour as well. when I went and had a look into the origin of the emotion that was causing greg to suddenly feel like all of a sudden kenny this terrible asshole, completely unaware of how much he hurts greg. replace kenny with joe and greg with seriah and you'll get the understanding.

#### why do I terat everyone the same

anyone who has had adventures in a particularly terraced social hierarchy or with a flatter one of elevated circles/platforms of trust, where some people in, certain circles have different syntax for engagement than others. I'm reminded of dr. tang telling me, he has a good list and a bad list and I was on the good list at first, but it seems like I had the brain haemorrhage, I left on the bad list. I've left a lot of people on their bad list, and various events in spain drove me to hate having an "official" status for everyone (we're not frineds right now. I don't trust him. he's ignoring me). for me, the social status was the worst thing about facebook -- as when you get your relationship status changed, it's a big f-ing deal, ya know. I tried to have some people elevated in status being especially *loyal* to them, like zaryn, augusto, etc. -- and I can tell you that I can never do anything right because I always perform the way people expect me to.

in all of my interactions with everyone, I don't think I've ever been able to behave properly or exactly to someone's expectations (sorry raquel and patricia), and by the end of spain I'd had it with conditional behaviour. I return back here and find that my "family" treats me just like everyone else does (purposefully hiding stuff from me and saying it doesn't exist or didn't happen when it obviously did) -- so, since they treat me like everyone else in the public treats me (hence my discussion with remi) -- this makes me wonder why I don't treat everyone else the same, too?

I've been treating people pretty much all the same more and more (less conditional behaviour), becasue it's a total mess to try and be the right way around the right people when I was in spain[^1]. I really liked the mental clarity and ease it gave me to be able to just "be me" wherever I went. social interactions becaxme easy for me, and I no longer needed alcohol to interact with someone socially.

this thing that mom always forced me have the perspective that my family is special and they get treated specially really has been a long battle. she's been determined to try and get me to have some special treatment for her[^3]. in our discussion about that, I explained to mom that melissa's desire for me to come home and be with her for her daughter -- is that I'm cold as ice in that melissa is nothing more to me than just another woman who wants me to meet her daughter. that rendering is a bit unfair because that's clearly my words now -- but -- back then, I told people what they want to hear, so I propbably told her whatever she wanted to hear -- so who knows what I actually said, but the thing I'm sure is that had more to do with mom's expectations than anything -- because she has been, for a very very very long time trying to get me to *not* behave like jesus did telling his family and mother she's too slow and wants to stay in the mundane. let the dead bury the dead. I'm going toward awesome and nobody is going to stop me. I will *not* feel bad for someone else no matter what position in my family they are. neither will I feel sympathy for anyone. it's all attraction, so figure out what's causing you to get me to reflect you that way. nobody has a special status for me. I am blameless and I can prove it. (lawyer power play, k-dawg style)

I choose to feel the way I want to feel and the way I feel determines how interactions play out. so I really do like acting, which for me is feeling the way I want to feel, and letting my body assume the other feeling/concept as if it's reality -- because when I'm acting, I'm in control of how I feel. if I'm not acting, I'm reflecting you all. it's fun for me to reflect (more on this in a sec), so keep em' comin. I'll prolly just write about it here, probably.

it's important to note that I *wanted* to live in another country *away* from my family. I used to find their expectations that I will treat them difficult to live around, tryng to get away from it. dispite their expectations, I'm still quite grateful to be in physical form and I show appreciation to those around me all the time, but I don't think that I need to go back to trying to figure out how I should behave around other people. I strongly disagree with the various behaviour modification techniques like making lists of who's naughty and nice, and then expecting them to behave like the status I've put them in behaves. no! everyone can behave however they want. I feel physically like the people around me feel like... let me explain.

I'm a true 4th ray in every sense of balance and harmony. anyone else who were to experience the 4th ray perspective as strongly as I do, would be passing a terrible time in life because they would believe that the awful anger and hatred that my body feels in reflection to greg is how *I* feel. I don't *really* feel that way. it came with greg's appearance and left with him -- and it's really good thing for me to know that the physical sensation that my body feels is *not* the way I *really* feel... it's really good to know that. pushing against me, usually produces positive change because of my perception, so go ahead and push against me, cause things usually turn out OK (at least for me, and everyone else too -- all -- only on the condition that you can perceive yourself as OK).

most 4th rays, because they're so sensitive to others, they immediately take on the emotion of people and situations around them (I'm thinking specifically of the example of marcos and that extremely loud motorcycle). therefore, because they feel like the people around him feel, they need to control who they're around.

oh yes, it was very easy to see with marcos. when he was around young andrea he felt one way, but then when she started to change, the way that marcos felt around her changed with her. it was like "I don't know you anymore".

so, what most 4th rays do is they make circles of trust and only those that meet up to some arbitrary metrics (which no one can ever know -- like a secret society), then -- and only then, can they let them into their circle of a bit more trust (you gatta earn it).

yes, the azcona family was actually the last straw, as that's when I really decided I'm going my own way and others can follow along if they want, but I'm not going to try and read their minds on how they want me to behave. they can behave however they want -- and so can I. take it or leave it. I'm going at it on my own. join me if you want but don't expect me to treat/reflect you any different than anyone else.

[1]: this was one of raquel's main contentions with me, because I behaved the same way around zaryn (which is a reflection of him) as I did when she was around. when it was just me and raqael, I was a reflection of her, so things went well, but when more people joined us, I started to reflect more other people's behaviours. raquel sees me behave like zaryn around zaryn and thinks that deep down I'm like zaryn or that I've changed or gone to the dark side. if she only could have known, right? back then, I didn't know yet that in the reflective aspect, I'm even more feminine than she is -- as most girls these days are building up those elevated cirtcles with elaborate systems and syntaxes of interaction between them[^2].
...
4. how large my own concepts are on the road (amplitude)
5. the shape of the concepts on the road (perception)
...
#### 2023-02-01 01:22 - followup: ideas from my perception of the female perspective

many reactions to this, and I even had another idea (I'll say it shortly), but no go. I don't think they like the ideas I presented. most notably were the reactions to saying that I'd love to take the "frozen" route, and jump into the body of a girl. on one hand, it felt like there were some interested in seeing what I would be like as a girl.

however, the majority of the reactions seemed to say that I would be *too* attractive as a girl. included with the reaction were a number of concepts about the "fallen angels" coming from heaven/mars down because the women were so attractive, and so if they have their galaxy setup going were everything is perfectly buttoned down and they're at the top of everything, but looking down on the new set of females (replicas of me), the reaction was that I would, once again, cause them to desire to come down, because of how accepting of them I am.

I explored the concept more, and there were two notable aspects to it. first was that apparently girls used to be insanely powerful (as in energetic), and when paired with a girl, a man could be extremely powerful (cause she bumps up the amplitude/size of all the concepts on the road), however because she's a reflector, what ends up happening is that she gets imprinted with the man's concepts and then starts amplifying those. when the man's concepts are good, it's really nice for him, but when they're bad, then he has to deal with his own concepts coming to life in bigger and bigger size.

interestingly enough, I noticed that major parts of egyptian religion (as established by ra) were designed to make a framework for manifestation for the girls. we can only really manifest concepts that we're capable of conceptualising/feeling, and so magick and mystery religions became a framework for manifesting things relating to the symbols provided by the religion. to clarify: both men and women provide emotional power (chi/vril) to power the manifestation, but girls provide a whole lot more (my theory is because of the dualing x-chromosomes). well, emotion manifests as a reflection of the symbolic (3rd ray) perception the manifesters, which is why religion used to be so important, and now why narrative is so important, because both use symbols.

the symbols are adjusted to generate an expectation of the result according to the narrative or religious ceremony. however, there is a bit of wiggle in there because symbols are only as good as the perceivers of them. just take me as an example: I receive symbols from others all the time, and they have one idea of what those symbols mean and how they look, which is a reflection of their emotion -- so they look for someone that will reflect, with very little modification, those symbols as perceived by the emitter/character. however, because I usually feel considerably better than the origin of the symbols and I have *understanding* of the symbols, they get interpretted entirely different by me. apparently I haven't been well enough educated in what the symbols are *supposed* to mean, that I manifest the wrong ones, sometimes.

anyway, the funny thing about these guys getting all interested in the girls, then the girls amplifying their own discord is that it caused a lot of them to stop liking boys, saying -- I don't want my own problems amplified. that concept also explained why women (especially non-virgins) default behaviour is so similar to nosebook's (or all major power structures) -- because girls over time came to reflect all of the ones in power, and so because women give birth, they carry that perception along to the next one. I could see that nosebook's default behaviour is encoded in generation after generation of women, and so when they first start activating that, it comes out..

to explain, for a man the X and the Y are both outputting competing signals, so one is exactly opposite the other, this means that the Y just needs to do the opposite of the X to amplify it, and the Y needs to output the same as the X to destroy the signal (cause they're 180(degrees) out of phase). for girls, there are two X's, so by default if both chromosomes are from the same line, both signals will cancel each other out perfectly -- so it'll be like she has a very quiet and undisturbed signal.

I don't know exactly the mechanism, but it looks like it has to do with the heart. I can see that on one end you have the concepts of the brain blocking the reception of the pineal, and so as she makes it through life gaining concepts, she starts to unlock her own self-canceling signal by doing the opposite of what she's "supposed" to do (ie. the default programming). also, like I mentioned previously, the sex organs also increase receptivity/emission that when she has her first sexual experience, that's the other side of the heart, so the concepts in her perception (these are the two sides to the hear) will get kind of adjusted by the experience to reflect the feeling of the experience.

both changing her conceptual perception and a sexual experience will put her out of balance, so long as she's not updating her own concepts to release any resistance accumulated from learning from social and cultural interactions, in addition to sexual interactions. getting back into balance will be a process of updating one's perception, or not resisting the input signal in the first place (which is why I suggest that prostitutes don't push against the awfulness of men they're sleeping with, because she accumulates everything she resists, and amplifies everything she doesn't resist) -- therefore it's all about learning how to see everything, even the most grossest most dispicable stuff from a non-resistant perspective.

the other thing that I've noticed before is that there is another cycle where one set of perceptions (encoded by her father) becomes more powerful, and then it goes back to become the perceptions of her mother. I think this has the added effect of, as the girl grows up, she'll naturally start to reflect her father's perception doing the exact opposite of what her mother values in her perception.

---

looking at it, it's kind of interesting to me because men sorta need women to continue on theirselves. this was the difficulty of elizabeth 1, where she having the female bloodline that's an optimal reflection opposite of the Y of the kings, she's expected to produce an heir so that they can continue on. therefore, their job is to find ways to trick her into producing an heir for them to transfer their consciousness into.

however, on the opposite end of things, women are kind of caught because she's carrying all of this awful default  programming in her genetics, which is normally deactivated. until her first sexual experience (getting stronger each experience after that, because she's now attracting those concepts even stronger).

then, like I mentioned (in a monologue earlier), lesbian sex just isn't as satisfying as sex with a man. I think it's because you want something to go "inside" so that you can get the full-body experience of the connection -- therefore, from the female perspective it feels like you would really *need* a man to get that satifsying physical experience, but men have it easy because a same-sex relationship for a man still has the "inside" experience, and also increases attraction. therefore, it appears unfair that men have it so easy.

personally, I believe that women have a much more powerful configuration than men do, but they do not take advantage of it because they're so busy worrying about everyone else (which I think came orignally as a reflection of the nosebook style of thought that started so many of them out), and they simply just don't go their own way. if I were a woman, I'd do lots of things differently, and one of the major things would be simply to not care so much about what anyone else is doing (hyper-individuality), maximising my own conceptual acquisition and improvement rates. I wouldn't push against anything.

in my present state of pretty low resistance, I have a pretty powerful rate of manifestation of my concepts, and also a pretty good navigational system -- so much so that I don't really need to emit to go toward what I want -- simply it comes toward me -- therefore, if I were to suddenly change over to a woman, I would be already roughly twice as powerful as I am now, AND sex just simply wouldn't make any sense to me; why would I want to motor my way toward what I want, when things are already coming to me twice as fast as they are now? everything would be extremely effortless. however, I think a lot of other women would kinda hate me because of that. in order to get everything so effortless, I would have completely rewired (much like I have already done, which is why mom gets so angry with me not respecting her default programming), which is why I "rub [mom] the wrong way" and why she knows I'm probably right about [some crazy idea] but it takes a while to adjust her concepts, because she's fighting a second self-reinforcing default programming.

#### 2023-02-01 02:46 - followup: a really bad idea

this idea combines concepts from [the original response to sepehr](/sepehr-thoughts.md#2023-01-29-0641---venus-and-lucifer), and the prvious followup. after writing this original entry, I had another idea from the "two witnesses" come to mind. there is similarity between Rev 11 (twice 11 brethren) and Zech 4 (worthless shepherd). I wondered why aryan legends are the only ones that have mercury/thoth as having self-sacrificed, except for this one prophechy in the OT of the "worthless shepherd" (who gives his right eye). it culminates into this...

I mentioned that in the process of giving up my left eye, because I've passed puberty, when it grows back, it grows back genderless. nobody has ever confirmed to me whether I am actually an X3 or not, but I assume I am, and I think I've reconstructed that using my own perception. well, what if I did become the "worthless shepherd"?? if they were to disable my right side, I would be back in the same situation I was before, but my left-hemisphere would be the one that doesn't work. what happened is, my right/logical side learned how to recover my form of perception and regain control over my left side again. during that process, my right side had to adjust a lot of his perception (the stressed man in the picture), in order to regain functionality of my left side (and not shake).

so if any of what I wrote there is true, then if I get my other side paralysed again, my left side would return back the functionality of my right as a reflection of its perception; I will become an X4. this process could be repeated, I suppose to continue to produce more and more pure ungendered aspects of myself.

so, I was thinking about the timing of it, and there's this weird thing about the how long these "two witnesses" are prophesying. one says 42 months, and the other is 1260 days. common perception is that this means 3.5 years. it's often times troubled me what this means, but right after writing this entry yesterday, I had the idea that perhaps the 3.5y amount is referring to *solar years*. so if the twice 11 brethren first appeared in my body in april 2000, and we'll go with the common conception that a solar year is about 11 earth years, then 3.5 solar years is about 39.5y -- which would be like ~2040 or so. if the time is counted, not when kenny-prime is born, but when kenny was born, that time is quickly approaching -- and the "beast" will emerge very soon and kill me. it's all really handwavy -- I know. it's not the metrics of the idea but the concept itself, which is that every ~40y or so, I get one side paralysed, allowing me to be "reborn" and to do some further updates to the genome as a reflection of my perception.

there are a number of things that I really like about this concept and a few potential caviats as well. I'll try and go over them all (but inevitably I'll forget something).

first, I really like the idea of rebuilding my right side. it has the added benefit that it'll likely dramatically reduce the amount of solar output, because I'll be attracting a lot less. it'll be a completely different experience from the previous one. I'll be coming back online in the presence of nosebook, which means that they'll largely imprint the concepts that they want and restrict the concepts that they don't want. also, the side of me that's going to be doing the teaching is going to be my left side. I have no idea what my left side is like because I basically don't know her at all. I consider her as the symbolic equivalent of 1st ray female (anatau), and but there have been a whole lot of utilisation of her and I don't really know her, so she's not likely the "pure" desire little girl that I used to know her as -- and instead probably something a bit more of a reflection of the people that are using her form of perception.

the other thing to consider about this is whether during this reparalysis is if I'm going to be around other girls, because I'll become a reflection of them. my anatau was born into a very individualistic kenny, and really at the peak of starting to learn how to work together, the vallecas incident happened, from which is where I kinda "lost contact" (minus a few times watching stars and stuff), and so because I no longer have access to that, I learned hyper-individuality because I no longer had access to her. if I'm around girls, that's going to be a very different experience. learning on my own has been a very significant aspect of learning to be who I am now.

then, there's the perspective of those that "use" my opposite side. almost certainly I'll take on their values, preferences, and perception initially -- which will be kinda bad probably. other girls will either remove theirselves from me because I've (overnight) turned into the thing that they hate the most: the personification of nosebook. I won't be the soft person that I am now (and it's pretty debatable how "soft" I am presently, anyway). that will give them a chance to now occupy (and "corrupt") my new right side. it has some interesting ideas to it which are too complex to be comprehensible.

I think that for them, it'd be pretty cool, because they'll be able to use that side of me visually, so that means my conceptual capability in my imagination will become available to them. I personally can't imagine how one would visually "see" a concept, and furthermore, I don't know how one angle of a concept would "look" compared to it's opposite angle -- cause this is kind of like trying to visualise 0, and then turn it around to see Infinity -- totally visually incomprehensible, yet without visuals, it's easy to perceive and analyse.

however, as a disadvantage to them, if I'm becoming an X4 or X5, then I'm pretty sure this will cause an evolution in girls (because their code spreads pretty quickly, and it's only the physically reinforcing things like culture, social, religion, and narrative that maintain the slight differences in the different default programming) -- and so if the new X pair is going to be getting its childhood under(?) the affection of a bunch of girls, this is *really* going to make the fallen angels conecpt that I perceived in the previous followup to be WAY WORSE. like, we'll be WAY more attractive than ever before. irresistable, I would have to say.

the other (dis)advantage, depending on how you look at it, is that if I keep raising in power, I'll probably do so in feminine form. that may possibly be easier for some to stomach than others ("the matriarch"). I don't really want to be in power though, so I imagine that I would probably want to disable my opposite side again and start over, continually improving, but that would be decided in the future, because my right side would be the independent side, and I don't know if my users would want to lose that independent instinct or not.

### 2023-02-04 16:12 - in back or front?
...
### 2023-03-14 12:36 - contemplating gambling (shoot that ship down, fighting just to win)

yesterday, I went down to talk to my dad in a place that was compatible with his frequency (we're just wayy off from how we perceive reality). he told me a few things about how hard it is to live up to one's own impossible expectations and a few othr things that I can't remember now -- though we ended up talking about gambling. I explained that I didn't understand what he was talking about because I didn't see the stuff that he thought was a gamble, as a gamble; it's not like it's a card game where you don't have any control over the hand you're dealt (RNG + skill); instead, for his business, he has full control over it and can easily see if it's going the way he wants it to go or not (desire + skill).

anyway, I tried to start to figure out the gambling thing because I was seeing a concept in relation to "the titanic", because in cameron's interview on charlie rose, his description of jack and rose were interesting to me. it was a very abstract concept that I didn't fully understand until today. I talked about the [mechanism for how the ship sank](/string-board.md#2023-02-17-0359---followup-fairy-tales-and-the-titanic) before, but now I can see that it's all about this perception of the gamble.

you see, all of the anti-federal-reservers were on the titanic when it went down. it seems likely to me that the character in the film that rose was betrothed to was likely one of those powerful money guys that was against the federal reserve. rose fell in love with this gambling hot-shot type, which is, if you're against the creation of the federal reserve, the reason is likely the same: instead of having a stable and secure foundation for the financial system, the federal reserve is entirely made up. it's pure magic, as none of the money that's given out actually has any backing to it; it's a complete gamble.

so what happens is, for tthese guys that have really extreme depth perception, they manifest the symbols that are present in perception outward into the world (this happens all the ttime to me). so when, jack swoops in and rose falls in love with a gambler, this is an externalisation of the same symbols -- just replace rose with the bloved amaruca (land of the free, and plumed serpent), and jack with federal reserve all those that put it into place... sepehr has a number of videos on it...

@[youtube](https://www.youtube.com/watch?v=fAPYSeOGoD8)

the federal reserve system, being purely magical, no longer relies on physical laws in order to operate, and so therefore the *probabilities* of that system destabilising, are not longer rooted in reality, but now upon the gamblers' analysis of the situation. so to the rich guy that was betrothed to rose, this signaled the end of the USA -- being carried off by the gamblers, which finally explained something I never understood about the movie, which is why jack had to die (I remember thinking there was enough space for him on the boat or someting), and it's because jack (federal reserve gamblers), had to die so that the rose can continue on.

now the explanation: a similar set of symbols have been happening lately as well. as I mentioned, I identify with rose a bit more than I identify with jack (cause I don't gamble), and the idea of building a matrix in the astral, is exactly the same as the federal reserve. I know that it'll be fine for as long as it's related to me cause I represent physical stablity of attraction/reflection. all things happening in my perception are attracted, and because the "great attractor at the end of time" is what's pulling me toward infinity/eternity, I'm pretty stable. I'm not a gamble(asterisk).

one of the other things that I talked with my father about is death, and I explained to him that death (in a system of attraction and perception) is not at all a big problem. we're here working things out in the physical for the reason of gaining XP (which I define as realising/understnading desire as a reflection of oneself), and so here in these time zones that we're in now, we're in the middle of all of our *own* perceptions externalised about why that desire is not realised as a manifestaiton oneself (I AM ... that I thought I needed/wanted to feel good). therefore, when one dies, the resistance that one has toward that realisation goes away instantly, and you can become everything that you thought you could be. so, death is actually a good thing.

death and the desire tto hang on to reality for longer than necessary is kind of like playing a game, and so because you can't beat the boss in that level, you just sit outside the boss door and wait for him to go away (obviously he never does), so you wait forever. just die, get a new perspective and try again until you finally get it. then later, if you want to perfect/optimise your run, you can get better and better at beating it.

the other thing that I explained is that th way that one perceives others' deaths (grief and anguish) is just a reflection of how attached one is to the current level. so, for someone like me, who doesn't have much to prove anymore (polly cause I've already beat the level a few times and am just optimising/improving technique), I don't really feel death to be such a big deal (you have to lose your life tto gain it) -- but then again, if I'm not that worried about dying myself, maybe that increases the gamble. something to worry about, for sure :)

---

the next thing that I noticed when talking to dad, is that I mentioned that I noticed that I had a giant hole in my head where a pineal gland was located. it seems to me, this is probably why I don't have an imagination. though, it's a "disadvantage" to not have a way to visualise concepts, I've come to really like it, so much that I want to make it physiologically impossible for me to see images. I also want to eliminate the possiblity for kundalini to rise. I didn't really understand why that was until after talking with dad.

you see, all of dad's gambling ideas, goals, and aspirations are all located in the (2nd ray) pineal gland area, so instead of "seeing" these desires/fears inside of my head from the pineal gland, instead (because I don't have one), I manifest all of these 2nd ray aspects out into my physical space so that I can interact with these concepts. they show up as real people, bands, songs, ideas, and is the reason why my reality is so narrative. the 2nd ray perspective is one of narrative, because we have on top all of the desires that are going into the goals and aspirations, and then on bottom there is the symbolic reality of how things work (the solar regime, as interpretted by the automaton), and that produces a number of perspectives looking back into *history* (epimethian perspective). epimetheus' perspective combines with desires, and that creates the promethian perspective -- which is, a series of probabilities and rightness, which then produces a very high frequency (prolly past UV) picture which makes a feeling that cascades down to the spectral and astral.
